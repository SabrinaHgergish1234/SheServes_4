 ...
 * @license Zlib
 */
var er = "6.36.6", tr = class {
  /**
   * Frees internal resources.
   */
  dispose() {
  }
}, st = 1 / 1e3, ir = 1e3, ti = class {
  /**
  ...
  get delta() {
    return this._delta * st;
  }
  get fixedDelta() {
    return this._fixedDelta * st;
  }
  set fixedDelta(e) {
    this._fixedDelta = e * ir;
  }
  get elapsed() {
    return this._elapsed * st;
  }
  /**
   * Updates this timer.
   *
   ...
   */
  constructor(t = "Pass", i = new ht(), r = new Gi()) {
  ...
  set fullscreenMaterial(t) {
    let i = this.screen;
    i !== null ? i.material = t : (i = new Xt(vt.fullscreenGeometry, t), i.frustumCulled = !1, this.scene === null && (this.scene = new ht()), this.scene.add(i), this.screen = i);
  }
  /**
  ...
  dispose() {
    for (const t of Object.keys(this)) {
      const i = this[t];
      (i instanceof T || i instanceof Zt || i instanceof je || i instanceof vt) && this[t].dispose();
    }
...
#include <dithering_fragment>
}`, le = "varying vec2 vUv;void main(){vUv=position.xy*0.5+0.5;gl_Position=vec4(position.xy,1.0,1.0);}", Ne = class extends w {
  /**
   ...
   */
  constructor(e, t = !0) {
    super("CopyPass"), this.fullscreenMaterial = new Ne(), this.needsSwap = !1, this.renderTarget = e, e === void 0 && (this.renderTarget = new T(1, 1, {
      minFilter: P,
      magFilter: P,
      stencilBuffer: !1,
      depthBuffer: !1
   ...
   */
  constructor(e, t) {
    super("MaskPass", e, t), this.needsSwap = !1, this.clearPass = new pe(!1, !1, !0), this.inverse = !1;
  }
  set mainScene(e) {
    this.scene = e;
  }
   ...
   */
  render(e, t, i, r, a) {
    const s = e.getContext(), n = e.state.buffers, o = this.scene, l = this.camera, u = this.clearPass, f = this.inverted ? 0 : 1, h = 1 - f;
    n.color.setMask(!1), n.depth.setMask(!1), n.color.setLocked(!0), n.depth.setLocked(!0), n.stencil.setTest(!0), n.stencil.setOp(s.REPLACE, s.REPLACE, s.REPLACE), n.stencil.setFunc(s.ALWAYS, f, 4294967295), n.stencil.setClear(h), n.stencil.setLocked(!0), this.clearPass.enabled && (this.renderToScreen ? u.render(e, null) : (u.render(e, t), u.render(e, i))), this.renderToScreen ? (e.setRenderTarget(null), e.render(o, l)) : (e.setRenderTarget(t), e.render(o, l), e.setRenderTarget(i), e.render(o, l)), n.color.setLocked(!1), n.depth.setLocked(!1), n.stencil.setLocked(!1), n.stencil.setFunc(s.EQUAL, 1, 4294967295), n.stencil.setOp(s.KEEP, s.KEEP, s.KEEP), n.stencil.setLocked(!0);
  }
}, sr = class {
  /**
  ...
  constructor(e = null, {
    ...
    this.renderer = null, this.inputBuffer = this.createBuffer(t, i, a, r), this.outputBuffer = this.inputBuffer.clone(), this.copyPass = new _e(), this.depthTexture = null, this.passes = [], this.timer = new ti(), this.autoRenderToScreen = !0, this.setRenderer(e);
  }
  /**
  ...
  setRenderer(e) {
    if (this.renderer = e, e !== null) {
      ...
      r === W && e.outputColorSpace === y && (this.inputBuffer.texture.colorSpace = y, this.outputBuffer.texture.colorSpace = y, this.inputBuffer.dispose(), this.outputBuffer.dispose()), e.autoClear = !1, this.setSize(t.width, t.height);
  ...
  createBuffer(e, t, i, r) {
    const a = this.renderer, s = a === null ? new p() : a.getDrawingBufferSize(new p()), n = {
      minFilter: P,
      magFilter: P,
      stencilBuffer: t,
      depthBuffer: e,
      type: i
    }, o = new T(s.width, s.height, n);
    return r > 0 && (o.ignoreDepthForMultisampleCopy = !1, o.samples = r), i === W && a !== null && a.outputColorSpace === y && (o.texture.colorSpace = y), o.texture.name = "EffectComposer.Buffer", o.texture.generateMipmaps = !1, o;
  }
  /**
   ...
   */
  addPass(e, t) {
    const i = this.passes, r = this.renderer, a = r.getDrawingBufferSize(new p()), s = r.getContext().getContextAttributes().alpha, n = this.inputBuffer.texture.type;
  ...
  removePass(e) {
    ...
    if (i !== -1 && t.splice(i, 1).length > 0) {
      if (this.depthTexture !== null) {
        ...
        t.reduce(s, !1) || (e.getDepthTexture() === this.depthTexture && e.setDepthTexture(null), this.deleteDepthTexture());
      }
  ...
  render(e) {
    ...
    let r = this.inputBuffer, a = this.outputBuffer, s = !1, n, o, l;
    e === void 0 && (this.timer.update(), e = this.timer.getDelta());
    for (const u of this.passes)
      u.enabled && (u.render(t, r, a, e, s), u.needsSwap && (s && (i.renderToScreen = u.renderToScreen, n = t.getContext(), o = t.state.buffers.stencil, o.setFunc(n.NOTEQUAL, 1, 4294967295), i.render(t, r, a, e, s), o.setFunc(n.EQUAL, 1, 4294967295)), l = r, r = a, a = l), u instanceof ri ? s = !0 : u instanceof ii && (s = !1));
  }
  /**
  ...
  setSize(e, t, i) {
    ...
    const s = r.getDrawingBufferSize(new p());
...
var si = class {
  ...
  generate(e, t) {
    ...
    for (let h = 0, d = n.length, v = 1 / s; h < d; ++h)
      n[h] *= v;
  ...
  cloneMaterial(e) {
    ...
    for (const a in t) {
      const s = t[a].value;
      s.isRenderTargetTexture && (t[a].value = null, i.set(a, s));
    }
    const r = e.clone();
    for (const a of i)
  ...
  updateEffectiveSize() {
    ...
    t.width !== se ? i.width = t.width : t.height !== se ? i.width = Math.round(t.height * (e.width / Math.max(e.height, 1))) : i.width = Math.round(e.width * r), t.height !== se ? i.height = t.height : t.width !== se ? i.height = Math.round(t.width / Math.max(e.width / Math.max(e.height, 1), 1)) : i.height = Math.round(e.height * r);
  }
  /**
   * The effective width.
   *
  ...
  set scale(e) {
    this.s !== e && (this.s = e, this.preferredSize.setScalar(se), this.dispatchEvent({ type: "change" }), this.resizable.setSize(this.baseSize.width, this.baseSize.height));
  }
  /**
...
}, ot = /* @__PURE__ */ new ur(2), Et = class extends Set {
  /**
   ...
   */
  constructor(e, t = ot.getNextId()) {
    super(), this.exclusive = !1, this._layer = t, (this._layer < 1 || this._layer > 31) && (console.warn("Layer out of range, resetting to 2"), ot.reset(2), this._layer = ot.getNextId()), e !== void 0 && this.set(e);
  }
  /**
   ...
   */
  getShaderCode() {
    return Qr.get(this.blendFunction);
  }
}, ee = {
  VERY_SMALL: 0,
  SMALL: 1,
  ...
  VERY_LARGE: 4,
  HUGE: 5
}, Vr = `#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D inputBuffer;
#else
uniform lowp sampler2D inputBuffer;
#endif
...
#include <colorspace_fragment>
   ...
   */
  constructor(e = new Fe()) {
    super({
      name: "KawaseBlurMaterial",
      uniforms: {
        inputBuffer: new c(null),
        texelSize: new c(new Fe()),
        scale: new c(1),
        kernel: new c(0)
      },
      blending: z,
      ...
      fragmentShader: Vr,
      vertexShader: Wr
    }), this.setTexelSize(e.x, e.y), this.kernelSize = ee.MEDIUM;
  }
  /**
   * The input buffer.
   *
  ...
  constructor({
    ...
    const n = this.resolution = new x(this, a, s, t);
    n.addEventListener("change", (o) => this.setSize(n.baseWidth, n.baseHeight)), this._blurMaterial = new $e(), this._blurMaterial.kernelSize = e, this.copyMaterial = new Ne();
  }
  /**
   ...
   */
  render(e, t, i, r, a) {
    const s = this.scene, n = this.camera, o = this.renderTargetA, l = this.renderTargetB, u = this.blurMaterial, f = u.kernelSequence;
    let h = t;
    this.fullscreenMaterial = u;
    for (let d = 0, v = f.length; d < v; ++d) {
      const A = d & 1 ? l : o;
      u.kernel = f[d], u.inputBuffer = h.texture, e.setRenderTarget(A), e.render(s, n), h = A;
    }
    this.fullscreenMaterial = this.copyMaterial, this.copyMaterial.inputBuffer = h.texture, e.setRenderTarget(this.renderToScreen ? null : i), e.render(s, n);
  }
  /**
   * Updates the size of this pass.
   *
   ...
   */
  initialize(e, t, i) {
    i !== void 0 && (this.renderTargetA.texture.type = i, this.renderTargetB.texture.type = i, i !== W ? (this.blurMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1", this.copyMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1") : e !== null && e.outputColorSpace === y && (this.renderTargetA.texture.colorSpace = y, this.renderTargetB.texture.colorSpace = y));
  }
  /**
   * An auto sizing flag.
   *
...
gl_FragColor=vec4(l);
  ...
  constructor({
    ...
    const l = this.resolution = new x(this, n, o, r);
  ...
  render(e, t, i, r, a) {
    ...
    s.inputBuffer = t.texture, e.setRenderTarget(this.renderToScreen ? null : this.renderTarget), e.render(this.scene, this.camera);
  }
  /**
   * Updates the size of this pass.
   *
   ...
   */
  initialize(e, t, i) {
    i !== void 0 && i !== W && (this.renderTarget.texture.type = i, this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1");
  }
...
#include <colorspace_fragment>
   ...
   */
  render(e, t, i, r, a) {
    const { scene: s, camera: n } = this, { downsamplingMaterial: o, upsamplingMaterial: l } = this, { downsamplingMipmaps: u, upsamplingMipmaps: f } = this;
    let h = t;
    this.fullscreenMaterial = o;
    for (let d = 0, v = u.length; d < v; ++d) {
      const A = u[d];
      o.setSize(h.width, h.height), o.inputBuffer = h.texture, e.setRenderTarget(A), e.render(s, n), h = A;
    }
    this.fullscreenMaterial = l;
    for (let d = f.length - 1; d >= 0; --d) {
      const v = f[d];
      l.setSize(h.width, h.height), l.inputBuffer = h.texture, l.supportBuffer = u[d].texture, e.setRenderTarget(v), e.render(s, n), h = v;
    }
  }
  /**
   * Updates the size of this pass.
  ...
  setSize(e, t) {
    ...
    for (let s = 0, n = this.downsamplingMipmaps.length; s < n; ++s)
      r = Math.round(r * 0.5), a = Math.round(a * 0.5), this.downsamplingMipmaps[s].setSize(r, a), s < this.upsamplingMipmaps.length && this.upsamplingMipmaps[s].setSize(r, a);
  }
  /**
   * Performs initialization tasks.
   *
  ...
  constructor(e, t, {
    ...
    super(), this.name = e, this.renderer = null, this.attributes = i, this.fragmentShader = t, this.vertexShader = o, this.defines = a, this.uniforms = s, this.extensions = n, this.blendMode = new ni(r), this.blendMode.addEventListener("change", (l) => this.setChanged()), this._inputColorSpace = Je, this._outputColorSpace = tt;
  }
  /**
  ...
  dispose() {
    for (const e of Object.keys(this)) {
      const t = this[e];
      (t instanceof T || t instanceof Zt || t instanceof je || t instanceof O) && this[e].dispose();
    }
  }
}, qr = `#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D map;
#else
uniform lowp sampler2D map;
#endif
uniform float intensity;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){vec4 texel=texture2D(map,uv);outputColor=vec4(texel.rgb*intensity,texel.a);}`, fi = class extends I {
  /**
...
float focusNear=clamp(focus-dof,0.0,1.0);float focusFar=clamp(focus+dof,0.0,1.0);float low=step(linearDepth,focusNear);float high=step(focusFar,linearDepth);float factor=(linearDepth-focusNear)*low+(linearDepth-focusFar)*high;vec2 dofBlur=vec2(clamp(factor*aperture,-maxBlur,maxBlur));vec2 dofblur9=dofBlur*0.9;vec2 dofblur7=dofBlur*0.7;vec2 dofblur4=dofBlur*0.4;vec4 color=inputColor;color+=texture2D(inputBuffer,uv+(vec2(0.0,0.4)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.15,0.37)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.29,0.29)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(-0.37,0.15)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.40,0.0)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.37,-0.15)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.29,-0.29)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(-0.15,-0.37)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.0,-0.4)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(-0.15,0.37)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(-0.29,0.29)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.37,0.15)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(-0.4,0.0)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(-0.37,-0.15)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(-0.29,-0.29)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.15,-0.37)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.15,0.37)*aspectCorrection)*dofblur9);color+=texture2D(inputBuffer,uv+(vec2(-0.37,0.15)*aspectCorrection)*dofblur9);color+=texture2D(inputBuffer,uv+(vec2(0.37,-0.15)*aspectCorrection)*dofblur9);color+=texture2D(inputBuffer,uv+(vec2(-0.15,-0.37)*aspectCorrection)*dofblur9);color+=texture2D(inputBuffer,uv+(vec2(-0.15,0.37)*aspectCorrection)*dofblur9);color+=texture2D(inputBuffer,uv+(vec2(0.37,0.15)*aspectCorrection)*dofblur9);color+=texture2D(inputBuffer,uv+(vec2(-0.37,-0.15)*aspectCorrection)*dofblur9);color+=texture2D(inputBuffer,uv+(vec2(0.15,-0.37)*aspectCorrection)*dofblur9);color+=texture2D(inputBuffer,uv+(vec2(0.29,0.29)*aspectCorrection)*dofblur7);color+=texture2D(inputBuffer,uv+(vec2(0.40,0.0)*aspectCorrection)*dofblur7);color+=texture2D(inputBuffer,uv+(vec2(0.29,-0.29)*aspectCorrection)*dofblur7);color+=texture2D(inputBuffer,uv+(vec2(0.0,-0.4)*aspectCorrection)*dofblur7);color+=texture2D(inputBuffer,uv+(vec2(-0.29,0.29)*aspectCorrection)*dofblur7);color+=texture2D(inputBuffer,uv+(vec2(-0.4,0.0)*aspectCorrection)*dofblur7);color+=texture2D(inputBuffer,uv+(vec2(-0.29,-0.29)*aspectCorrection)*dofblur7);color+=texture2D(inputBuffer,uv+(vec2(0.0,0.4)*aspectCorrection)*dofblur7);color+=texture2D(inputBuffer,uv+(vec2(0.29,0.29)*aspectCorrection)*dofblur4);color+=texture2D(inputBuffer,uv+(vec2(0.4,0.0)*aspectCorrection)*dofblur4);color+=texture2D(inputBuffer,uv+(vec2(0.29,-0.29)*aspectCorrection)*dofblur4);color+=texture2D(inputBuffer,uv+(vec2(0.0,-0.4)*aspectCorrection)*dofblur4);color+=texture2D(inputBuffer,uv+(vec2(-0.29,0.29)*aspectCorrection)*dofblur4);color+=texture2D(inputBuffer,uv+(vec2(-0.4,0.0)*aspectCorrection)*dofblur4);color+=texture2D(inputBuffer,uv+(vec2(-0.29,-0.29)*aspectCorrection)*dofblur4);color+=texture2D(inputBuffer,uv+(vec2(0.0,0.4)*aspectCorrection)*dofblur4);outputColor=color/41.0;}`, $r = class extends I {
...
}, ea = "uniform float brightness;uniform float contrast;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){vec3 color=inputColor.rgb+vec3(brightness-0.5);if(contrast>0.0){color/=vec3(1.0-contrast);}else{color*=vec3(1.0+contrast);}outputColor=vec4(color+vec3(0.5),inputColor.a);}", ta = class extends I {
  /**
  ...
  constructor({ blendFunction: e = g.SRC, brightness: t = 0, contrast: i = 0 } = {}) {
    super("BrightnessContrastEffect", ea, {
      blendFunction: e,
      uniforms: /* @__PURE__ */ new Map([
        ["brightness", new c(t)],
        ["contrast", new c(i)]
...
}, ia = "void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=vec4(vec3(average(inputColor.rgb)),inputColor.a);}", ra = class extends I {
  /**
   ...
   */
  constructor(e) {
    super("ColorAverageEffect", ia, { blendFunction: e });
  }
}, aa = "uniform float factor;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=vec4(floor(inputColor.rgb*factor+0.5)/factor,inputColor.a);}", sa = class extends I {
  /**
...
outputColor=vec4(ra.x,inputColor.g,ba.x,max(max(ra.y,ba.y),inputColor.a));}`, oa = "uniform vec2 offset;varying float vActive;varying vec2 vUvR;varying vec2 vUvB;void mainSupport(const in vec2 uv){vec2 shift=offset*vec2(1.0,aspect);vActive=(shift.x!=0.0||shift.y!=0.0)?1.0:0.0;vUvR=uv+shift;vUvB=uv-shift;}", la = class extends I {
  ...
  constructor({
    ...
    super("ChromaticAberrationEffect", na, {
      vertexShader: oa,
...
}, ua = `void mainImage(const in vec4 inputColor,const in vec2 uv,const in float depth,out vec4 outputColor){
#ifdef INVERTED
vec3 color=vec3(1.0-depth);
#else
vec3 color=vec3(depth);
#endif
outputColor=vec4(color,inputColor.a);}`, ca = class extends I {
  /**
...
vec4 maxValue=texture2D(inputBuffer,vUv);for(int i=0;i<8;++i){vec4 kernel=kernel16[i];vec2 uv=step*kernel.xy+vUv;maxValue=max(texture2D(inputBuffer,uv),maxValue);uv=step*kernel.zw+vUv;maxValue=max(texture2D(inputBuffer,uv),maxValue);}gl_FragColor=maxValue;
  ...
  generateKernel() {
    ...
    let r = 0, a = 0;
    for (let s = 0, n = Math.sqrt(80); s < 80; ++s) {
      const o = s * e, l = Math.sqrt(s) / n, u = l * Math.cos(o), f = l * Math.sin(o);
      s % 5 === 0 ? (i[a++] = u, i[a++] = f) : (t[r++] = u, t[r++] = f);
    }
...
}, da = `#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D inputBuffer;
#else
uniform lowp sampler2D inputBuffer;
#endif
...
gl_FragColor=mask*texture2D(inputBuffer,vUv);
  ...
  constructor(e = null) {
    super({
      ...
      fragmentShader: da,
      vertexShader: le
    }), this.colorChannel = ce.RED, this.maskFunction = yt.DISCARD;
  }
  /**
   * The input buffer.
   *
   ...
   */
  set maskTexture(e) {
    this.uniforms.maskTexture.value = e, delete this.defines.MASK_PRECISION_HIGH, e.type !== W && (this.defines.MASK_PRECISION_HIGH = "1"), this.needsUpdate = !0;
  }
  /**
  ...
  render(e, t, i, r, a) {
    ...
    t !== null && s !== void 0 && s[this.input] !== void 0 && (s[this.input].value = t.texture), e.setRenderTarget(this.renderToScreen ? null : i), e.render(this.scene, this.camera);
  }
  /**
   * Performs initialization tasks.
   *
   ...
   */
  initialize(e, t, i) {
    i !== void 0 && i !== W && (this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1");
  }
...
#endif
vec4 result=inputColor*(1.0-cocNearFar.y)+colorFar;result=mix(result,colorNear,cocNearFar.x);outputColor=result;}`, pa = class extends I {
  /**
   ...
   */
  update(e, t, i) {
    const r = this.renderTarget, a = this.renderTargetCoC, s = this.renderTargetCoCBlurred, n = this.renderTargetMasked;
    if (this.target !== null) {
      const o = this.calculateFocusDistance(this.target);
      this.cocMaterial.focusDistance = o;
    }
    this.cocPass.render(e, null, a), this.blurPass.render(e, a, s), this.maskPass.render(e, t, n), this.bokehFarBasePass.render(e, n, r), this.bokehFarFillPass.render(e, r, this.renderTargetFar), this.bokehNearBasePass.render(e, t, r), this.bokehNearFillPass.render(e, r, this.renderTargetNear);
  }
  /**
   * Updates the size of internal render targets.
   *
...
varying vec2 vUvDown;varying vec2 vUvUp;varying vec2 vUvLeft;varying vec2 vUvRight;varying vec2 vUvDownLeft;varying vec2 vUvUpRight;varying vec2 vUvUpLeft;varying vec2 vUvDownRight;vec4 fxaa(const in vec4 inputColor,const in vec2 uv){float lumaCenter=luminance(inputColor.rgb);float lumaDown=luminance(texture2D(inputBuffer,vUvDown).rgb);float lumaUp=luminance(texture2D(inputBuffer,vUvUp).rgb);float lumaLeft=luminance(texture2D(inputBuffer,vUvLeft).rgb);float lumaRight=luminance(texture2D(inputBuffer,vUvRight).rgb);float lumaMin=min(lumaCenter,min(min(lumaDown,lumaUp),min(lumaLeft,lumaRight)));float lumaMax=max(lumaCenter,max(max(lumaDown,lumaUp),max(lumaLeft,lumaRight)));float lumaRange=lumaMax-lumaMin;if(lumaRange<max(EDGE_THRESHOLD_MIN,lumaMax*EDGE_THRESHOLD_MAX)){return inputColor;}float lumaDownLeft=luminance(texture2D(inputBuffer,vUvDownLeft).rgb);float lumaUpRight=luminance(texture2D(inputBuffer,vUvUpRight).rgb);float lumaUpLeft=luminance(texture2D(inputBuffer,vUvUpLeft).rgb);float lumaDownRight=luminance(texture2D(inputBuffer,vUvDownRight).rgb);float lumaDownUp=lumaDown+lumaUp;float lumaLeftRight=lumaLeft+lumaRight;float lumaLeftCorners=lumaDownLeft+lumaUpLeft;float lumaDownCorners=lumaDownLeft+lumaDownRight;float lumaRightCorners=lumaDownRight+lumaUpRight;float lumaUpCorners=lumaUpRight+lumaUpLeft;float edgeHorizontal=(abs(-2.0*lumaLeft+lumaLeftCorners)+abs(-2.0*lumaCenter+lumaDownUp)*2.0+abs(-2.0*lumaRight+lumaRightCorners));float edgeVertical=(abs(-2.0*lumaUp+lumaUpCorners)+abs(-2.0*lumaCenter+lumaLeftRight)*2.0+abs(-2.0*lumaDown+lumaDownCorners));bool isHorizontal=(edgeHorizontal>=edgeVertical);float stepLength=isHorizontal?texelSize.y:texelSize.x;float luma1=isHorizontal?lumaDown:lumaLeft;float luma2=isHorizontal?lumaUp:lumaRight;float gradient1=abs(luma1-lumaCenter);float gradient2=abs(luma2-lumaCenter);bool is1Steepest=gradient1>=gradient2;float gradientScaled=0.25*max(gradient1,gradient2);float lumaLocalAverage=0.0;if(is1Steepest){stepLength=-stepLength;lumaLocalAverage=0.5*(luma1+lumaCenter);}else{lumaLocalAverage=0.5*(luma2+lumaCenter);}vec2 currentUv=uv;if(isHorizontal){currentUv.y+=stepLength*0.5;}else{currentUv.x+=stepLength*0.5;}vec2 offset=isHorizontal?vec2(texelSize.x,0.0):vec2(0.0,texelSize.y);vec2 uv1=currentUv-offset*QUALITY(0);vec2 uv2=currentUv+offset*QUALITY(0);float lumaEnd1=luminance(texture2D(inputBuffer,uv1).rgb);float lumaEnd2=luminance(texture2D(inputBuffer,uv2).rgb);lumaEnd1-=lumaLocalAverage;lumaEnd2-=lumaLocalAverage;bool reached1=abs(lumaEnd1)>=gradientScaled;bool reached2=abs(lumaEnd2)>=gradientScaled;bool reachedBoth=reached1&&reached2;if(!reached1){uv1-=offset*QUALITY(1);}if(!reached2){uv2+=offset*QUALITY(1);}if(!reachedBoth){for(int i=2;i<SAMPLES;++i){if(!reached1){lumaEnd1=luminance(texture2D(inputBuffer,uv1).rgb);lumaEnd1=lumaEnd1-lumaLocalAverage;}if(!reached2){lumaEnd2=luminance(texture2D(inputBuffer,uv2).rgb);lumaEnd2=lumaEnd2-lumaLocalAverage;}reached1=abs(lumaEnd1)>=gradientScaled;reached2=abs(lumaEnd2)>=gradientScaled;reachedBoth=reached1&&reached2;if(!reached1){uv1-=offset*QUALITY(i);}if(!reached2){uv2+=offset*QUALITY(i);}if(reachedBoth){break;}}}float distance1=isHorizontal?(uv.x-uv1.x):(uv.y-uv1.y);float distance2=isHorizontal?(uv2.x-uv.x):(uv2.y-uv.y);bool isDirection1=distance1<distance2;float distanceFinal=min(distance1,distance2);float edgeThickness=(distance1+distance2);bool isLumaCenterSmaller=lumaCenter<lumaLocalAverage;bool correctVariation1=(lumaEnd1<0.0)!=isLumaCenterSmaller;bool correctVariation2=(lumaEnd2<0.0)!=isLumaCenterSmaller;bool correctVariation=isDirection1?correctVariation1:correctVariation2;float pixelOffset=-distanceFinal/edgeThickness+0.5;float finalOffset=correctVariation?pixelOffset:0.0;float lumaAverage=ONE_OVER_TWELVE*(2.0*(lumaDownUp+lumaLeftRight)+lumaLeftCorners+lumaRightCorners);float subPixelOffset1=clamp(abs(lumaAverage-lumaCenter)/lumaRange,0.0,1.0);float subPixelOffset2=(-2.0*subPixelOffset1+3.0)*subPixelOffset1*subPixelOffset1;float subPixelOffsetFinal=subPixelOffset2*subPixelOffset2*SUBPIXEL_QUALITY;finalOffset=max(finalOffset,subPixelOffsetFinal);vec2 finalUv=uv;if(isHorizontal){finalUv.y+=finalOffset*stepLength;}else{finalUv.x+=finalOffset*stepLength;}return texture2D(inputBuffer,finalUv);}void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=fxaa(inputColor,uv);}`, xa = "varying vec2 vUvDown;varying vec2 vUvUp;varying vec2 vUvLeft;varying vec2 vUvRight;varying vec2 vUvDownLeft;varying vec2 vUvUpRight;varying vec2 vUvUpLeft;varying vec2 vUvDownRight;void mainSupport(const in vec2 uv){vUvDown=uv+vec2(0.0,-1.0)*texelSize;vUvUp=uv+vec2(0.0,1.0)*texelSize;vUvRight=uv+vec2(1.0,0.0)*texelSize;vUvLeft=uv+vec2(-1.0,0.0)*texelSize;vUvDownLeft=uv+vec2(-1.0,-1.0)*texelSize;vUvUpRight=uv+vec2(1.0,1.0)*texelSize;vUvUpLeft=uv+vec2(-1.0,1.0)*texelSize;vUvDownRight=uv+vec2(1.0,-1.0)*texelSize;}", Da = class extends I {
...
}, wa = "uniform float gamma;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=LinearToGamma(max(inputColor,0.0),gamma);}", Ta = class extends I {
  /**
  ...
  constructor({ blendFunction: e = g.SRC, gamma: t = 2 } = {}) {
    super("GammaCorrectionEffect", wa, {
      blendFunction: e,
      uniforms: /* @__PURE__ */ new Map([
        ["gamma", new c(t)]
      ])
...
function Sa(e, t, i) {
  ...
  let a;
  if (r.has(t) || console.error("Invalid noise texture format"), i === W) {
    a = new Uint8Array(e * r.get(t));
    for (let s = 0, n = a.length; s < n; ++s)
      a[s] = Math.random() * 255 + 0.5;
  } else {
...
var et = class extends it {
   ...
   */
  constructor(e, t, i = qt, r = W) {
    super(Sa(e * t, i, r), e, t, i, r), this.needsUpdate = !0;
  }
}, Ea = "uniform lowp sampler2D perturbationMap;uniform bool active;uniform float columns;uniform float random;uniform vec2 seeds;uniform vec2 distortion;void mainUv(inout vec2 uv){if(active){if(uv.y<distortion.x+columns&&uv.y>distortion.x-columns*random){float sx=clamp(ceil(seeds.x),0.0,1.0);uv.y=sx*(1.0-(uv.y+distortion.y))+(1.0-sx)*distortion.y;}if(uv.x<distortion.y+columns&&uv.x>distortion.y-columns*random){float sy=clamp(ceil(seeds.y),0.0,1.0);uv.x=sy*distortion.x+(1.0-sy)*(1.0-(uv.x+distortion.x));}vec2 normal=texture2D(perturbationMap,uv*random*random).rg;uv+=normal*seeds*(random*0.2);}}", Ve = "Glitch.Generated";
function X(e, t) {
...
var Ca = class extends I {
  ...
  constructor({
    ...
    ), this.strength = r, this.mode = we.SPORADIC, this.ratio = s, this.chromaticAberrationOffset = e;
  }
  /**
   * Random number seeds.
   *
  ...
  set perturbationMap(e) {
    ...
    t !== null && t.name === Ve && t.dispose(), e.minFilter = e.magFilter = B, e.wrapS = e.wrapT = de, e.generateMipmaps = !1, this.uniforms.get("perturbationMap").value = e;
  }
  /**
   ...
   */
  update(e, t, i) {
    const r = this.mode, a = this.breakPoint, s = this.chromaticAberrationOffset, n = this.strength;
    let o = this.time, l = !1, u = 0, f = 0, h;
    r !== we.DISABLED && (r === we.SPORADIC && (o += i, h = o > a.x, o >= a.x + a.y && (a.set(
      X(this.delay.x, this.delay.y),
      X(this.duration.x, this.duration.y)
    ), o = 0)), u = Math.random(), this.uniforms.get("random").value = u, h && u > this.ratio || r === we.CONSTANT_WILD ? (l = !0, u *= n.y * 0.03, f = X(-Math.PI, Math.PI), this.seeds.set(X(-n.y, n.y), X(-n.y, n.y)), this.distortion.set(X(0, 1), X(0, 1))) : (h || r === we.CONSTANT_MILD) && (l = !0, u *= n.x * 0.03, f = X(-Math.PI, Math.PI), this.seeds.set(X(-n.x, n.x), X(-n.x, n.x)), this.distortion.set(X(0, 1), X(0, 1))), this.time = o), s !== null && (l ? s.set(Math.cos(f), Math.sin(f)).multiplyScalar(u) : s.set(0, 0)), this.uniforms.get("active").value = l;
  }
  /**
...
if(keep){gl_FragColor=texture2D(inputBuffer,vUv);}else{discard;}}`, Mt = class extends w {
  ...
  constructor() {
    super({
      ...
      defines: {
        ...
        DEPTH_PACKING_0: "0",
        DEPTH_PACKING_1: "0",
        DEPTH_TEST_STRATEGY: ye.KEEP_MAX_DEPTH
      },
      uniforms: {
        inputBuffer: new c(null),
  ...
  set keepFar(e) {
    this.maxDepthStrategy = e ? ye.KEEP_MAX_DEPTH : ye.DISCARD_MAX_DEPTH;
  }
  /**
...
#include <dithering_fragment>
  ...
  constructor(e, t, i = null) {
    super("RenderPass", e, t), this.needsSwap = !1, this.clearPass = new pe(), this.overrideMaterialManager = i === null ? null : new pt(i), this.ignoreBackground = !1, this.skipShadowMapUpdate = !1, this.selection = null;
  }
  set mainScene(e) {
    this.scene = e;
  }
  ...
  set overrideMaterial(e) {
    ...
    e !== null ? t !== null ? t.setMaterial(e) : this.overrideMaterialManager = new pt(e) : t !== null && (t.dispose(), this.overrideMaterialManager = null);
  }
  /**
   ...
   */
  render(e, t, i, r, a) {
    const s = this.scene, n = this.camera, o = this.selection, l = n.layers.mask, u = s.background, f = e.shadowMap.autoUpdate, h = this.renderToScreen ? null : t;
    o !== null && n.layers.set(o.getLayer()), this.skipShadowMapUpdate && (e.shadowMap.autoUpdate = !1), (this.ignoreBackground || this.clearPass.overrideClearColor !== null) && (s.background = null), this.clearPass.enabled && this.clearPass.render(e, t), e.setRenderTarget(h), this.overrideMaterialManager !== null ? this.overrideMaterialManager.render(e, s, n) : e.render(s, n), n.layers.mask = l, s.background = u, e.shadowMap.autoUpdate = f;
  }
...
uniform lowp sampler2D map;
#endif
void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=texture2D(map,uv);}`, lt = /* @__PURE__ */ new F(), Ft = /* @__PURE__ */ new L(), Pa = class extends I {
  /**
  ...
  constructor(e, t, {
    ...
    super("GodRaysEffect", Ba, {
      blendFunction: i,
      attributes: Q.DEPTH,
      uniforms: /* @__PURE__ */ new Map([
        ["map", new c(null)]
      ])
    }), this.camera = e, this._lightSource = t, this.lightSource = t, this.lightScene = new ht(), this.screenPosition = new p(), this.renderTargetA = new T(1, 1, { depthBuffer: !1 }), this.renderTargetA.texture.name = "GodRays.Target.A", this.renderTargetB = this.renderTargetA.clone(), this.renderTargetB.texture.name = "GodRays.Target.B", this.uniforms.get("map").value = this.renderTargetB.texture, this.renderTargetLight = new T(1, 1), this.renderTargetLight.texture.name = "GodRays.Light", this.renderTargetLight.depthTexture = new Ce(), this.renderPassLight = new He(this.lightScene, e), this.renderPassLight.clearPass.overrideClearColor = new H(0), this.clearPass = new pe(!0, !1, !1), this.clearPass.overrideClearColor = new H(0), this.blurPass = new ve({ kernelSize: f }), this.blurPass.enabled = u, this.depthMaskPass = new J(new Mt());
    const E = this.depthMaskMaterial;
    E.depthBuffer1 = this.renderTargetLight.depthTexture, E.copyCameraSettings(e), this.godRaysPass = new J(new vi(this.screenPosition));
    const C = this.godRaysMaterial;
    C.density = a, C.decay = s, C.weight = n, C.exposure = o, C.maxIntensity = l, C.samples = r;
   ...
   */
  update(e, t, i) {
    const r = this.lightSource, a = r.parent, s = r.matrixAutoUpdate, n = this.renderTargetA, o = this.renderTargetLight;
    r.material.depthWrite = !0, r.matrixAutoUpdate = !1, r.updateWorldMatrix(!0, !1), a !== null && (s || Ft.copy(r.matrix), r.matrix.copy(r.matrixWorld)), this.lightScene.add(r), this.renderPassLight.render(e, o), this.clearPass.render(e, n), this.depthMaskPass.render(e, o, n), r.material.depthWrite = !1, r.matrixAutoUpdate = s, a !== null && (s || r.matrix.copy(Ft), a.add(r)), lt.setFromMatrixPosition(r.matrixWorld).project(this.camera), this.screenPosition.set(
      Math.min(Math.max((lt.x + 1) * 0.5, -1), 2),
      Math.min(Math.max((lt.y + 1) * 0.5, -1), 2)
...
}, Ia = "uniform vec2 scale;uniform float lineWidth;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){float grid=0.5-max(abs(mod(uv.x*scale.x,1.0)-0.5),abs(mod(uv.y*scale.y,1.0)-0.5));outputColor=vec4(vec3(smoothstep(0.0,lineWidth,grid)),inputColor.a);}", Ra = class extends I {
  /**
...
#endif
void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=vec4(texture2D(lut,vec2(inputColor.r,0.5)).r,texture2D(lut,vec2(inputColor.g,0.5)).r,texture2D(lut,vec2(inputColor.b,0.5)).r,inputColor.a);}`, Na = class extends I {
  /**
  ...
  set lut(e) {
    this.uniforms.get("lut").value = e, e !== null && (e.type === j || e.type === _) && this.defines.set("LUT_PRECISION_HIGH", "1");
  }
}, pi = {
...
function Lt(e, t, i) {
  ...
  if (r.width = e, r.height = t, i instanceof Image)
    ...
    const s = a.createImageData(e, t);
    s.data.set(i), a.putImageData(s, 0, 0);
  }
  return r;
}
var oe = class gi {
  ...
  static from(t) {
    ...
    if (t instanceof Image) {
      const s = Lt(i, r, t);
      s !== null && (a = s.getContext("2d").getImageData(0, 0, i, r).data);
    } else
      a = t.data;
    return new gi(i, r, a);
  }
}, Ha = `"use strict";(()=>{var O={SCALE_UP:"lut.scaleup"};var _=[new Float32Array(3),new Float32Array(3)],n=[new Float32Array(3),new Float32Array(3),new Float32Array(3),new Float32Array(3)],Z=[[new Float32Array([0,0,0]),new Float32Array([1,0,0]),new Float32Array([1,1,0]),new Float32Array([1,1,1])],[new Float32Array([0,0,0]),new Float32Array([1,0,0]),new Float32Array([1,0,1]),new Float32Array([1,1,1])],[new Float32Array([0,0,0]),new Float32Array([0,0,1]),new Float32Array([1,0,1]),new Float32Array([1,1,1])],[new Float32Array([0,0,0]),new Float32Array([0,1,0]),new Float32Array([1,1,0]),new Float32Array([1,1,1])],[new Float32Array([0,0,0]),new Float32Array([0,1,0]),new Float32Array([0,1,1]),new Float32Array([1,1,1])],[new Float32Array([0,0,0]),new Float32Array([0,0,1]),new Float32Array([0,1,1]),new Float32Array([1,1,1])]];function d(a,t,r,m){let i=r[0]-t[0],e=r[1]-t[1],y=r[2]-t[2],h=a[0]-t[0],A=a[1]-t[1],w=a[2]-t[2],c=e*w-y*A,l=y*h-i*w,x=i*A-e*h,u=Math.sqrt(c*c+l*l+x*x),b=u*.5,s=c/u,F=l/u,f=x/u,p=-(a[0]*s+a[1]*F+a[2]*f),M=m[0]*s+m[1]*F+m[2]*f;return Math.abs(M+p)*b/3}function V(a,t,r,m,i,e){let y=(r+m*t+i*t*t)*4;e[0]=a[y+0],e[1]=a[y+1],e[2]=a[y+2]}function k(a,t,r,m,i,e){let y=r*(t-1),h=m*(t-1),A=i*(t-1),w=Math.floor(y),c=Math.floor(h),l=Math.floor(A),x=Math.ceil(y),u=Math.ceil(h),b=Math.ceil(A),s=y-w,F=h-c,f=A-l;if(w===y&&c===h&&l===A)V(a,t,y,h,A,e);else{let p;s>=F&&F>=f?p=Z[0]:s>=f&&f>=F?p=Z[1]:f>=s&&s>=F?p=Z[2]:F>=s&&s>=f?p=Z[3]:F>=f&&f>=s?p=Z[4]:f>=F&&F>=s&&(p=Z[5]);let[M,g,X,Y]=p,P=_[0];P[0]=s,P[1]=F,P[2]=f;let o=_[1],L=x-w,S=u-c,U=b-l;o[0]=L*M[0]+w,o[1]=S*M[1]+c,o[2]=U*M[2]+l,V(a,t,o[0],o[1],o[2],n[0]),o[0]=L*g[0]+w,o[1]=S*g[1]+c,o[2]=U*g[2]+l,V(a,t,o[0],o[1],o[2],n[1]),o[0]=L*X[0]+w,o[1]=S*X[1]+c,o[2]=U*X[2]+l,V(a,t,o[0],o[1],o[2],n[2]),o[0]=L*Y[0]+w,o[1]=S*Y[1]+c,o[2]=U*Y[2]+l,V(a,t,o[0],o[1],o[2],n[3]);let T=d(g,X,Y,P)*6,q=d(M,X,Y,P)*6,C=d(M,g,Y,P)*6,E=d(M,g,X,P)*6;n[0][0]*=T,n[0][1]*=T,n[0][2]*=T,n[1][0]*=q,n[1][1]*=q,n[1][2]*=q,n[2][0]*=C,n[2][1]*=C,n[2][2]*=C,n[3][0]*=E,n[3][1]*=E,n[3][2]*=E,e[0]=n[0][0]+n[1][0]+n[2][0]+n[3][0],e[1]=n[0][1]+n[1][1]+n[2][1]+n[3][1],e[2]=n[0][2]+n[1][2]+n[2][2]+n[3][2]}}var v=class{static expand(t,r){let m=Math.cbrt(t.length/4),i=new Float32Array(3),e=new t.constructor(r**3*4),y=t instanceof Uint8Array?255:1,h=r**2,A=1/(r-1);for(let w=0;w<r;++w)for(let c=0;c<r;++c)for(let l=0;l<r;++l){let x=l*A,u=c*A,b=w*A,s=Math.round(l+c*r+w*h)*4;k(t,m,x,u,b,i),e[s+0]=i[0],e[s+1]=i[1],e[s+2]=i[2],e[s+3]=y}return e}};self.addEventListener("message",a=>{let t=a.data,r=t.data;switch(t.operation){case O.SCALE_UP:r=v.expand(r,t.size);break}postMessage(r,[r.buffer]),close()});})();
`, Ot = /* @__PURE__ */ new H(), Le = class Ze extends Xe {
  /**
   ...
   */
  constructor(t, i) {
    super(t, i, i, i), this.type = j, this.format = N, this.minFilter = P, this.magFilter = P, this.wrapS = at, this.wrapT = at, this.wrapR = at, this.unpackAlignment = 1, this.needsUpdate = !0, this.colorSpace = Je, this.domainMin = new F(0, 0, 0), this.domainMax = new F(1, 1, 1);
  }
  /**
  ...
  scaleUp(t, i = !0) {
    const r = this.image;
    let a;
    return t <= r.width ? a = Promise.reject(new Error("The target size must be greater than the current size")) : a = new Promise((s, n) => {
      const o = URL.createObjectURL(new Blob([Ha], {
        type: "text/javascript"
      })), l = new Worker(o);
      l.addEventListener("error", (f) => n(f.error)), l.addEventListener("message", (f) => {
        const h = new Ze(f.data, t);
        this.colorSpace = h.colorSpace, h.type = this.type, h.name = this.name, URL.revokeObjectURL(o), s(h);
      });
   ...
   */
  applyLUT(t) {
    const i = this.image, r = t.image, a = Math.min(i.width, i.height, i.depth), s = Math.min(r.width, r.height, r.depth);
    if (a !== s)
      console.error("Size mismatch");
    else if (t.type !== j || this.type !== j)
      console.error("Both LUTs must be FloatType textures");
    else if (t.format !== N || this.format !== N)
      console.error("Both LUTs must be RGBA textures");
    else {
      const n = i.data, o = r.data, l = a, u = l ** 2, f = l - 1;
      for (let h = 0, d = l ** 3; h < d; ++h) {
        const v = h * 4, A = n[v + 0] * f, m = n[v + 1] * f, E = n[v + 2] * f, C = Math.round(A + m * l + E * u) * 4;
  ...
  convertToUint8() {
    if (this.type === j) {
      ...
      for (let r = 0, a = t.length; r < a; ++r)
        i[r] = t[r] * 255 + 0.5;
      this.image.data = i, this.type = W, this.needsUpdate = !0;
    }
    return this;
  }
  /**
  ...
  toDataTexture() {
    ...
    return r.name = this.name, r.type = this.type, r.format = this.format, r.minFilter = P, r.magFilter = P, r.wrapS = this.wrapS, r.wrapT = this.wrapT, r.generateMipmaps = !1, r.needsUpdate = !0, this.colorSpace = r.colorSpace, r;
  }
  /**
   ...
   */
  static from(t) {
    const i = t.image, { width: r, height: a } = i, s = Math.min(r, a);
    let n;
    if (i instanceof Image) {
      const u = oe.from(i).data;
      if (r > a) {
        n = new Uint8Array(u.length);
        for (let f = 0; f < s; ++f)
          for (let h = 0; h < s; ++h)
            for (let d = 0; d < s; ++d) {
              const v = (d + f * s + h * s * s) * 4, A = (d + h * s + f * s * s) * 4;
  ...
  static createNeutral(t) {
    ...
    for (let n = 0; n < t; ++n)
      for (let o = 0; o < t; ++o)
        for (let l = 0; l < t; ++l) {
          const u = (n + o * t + l * r) * 4;
          i[u + 0] = n * a, i[u + 1] = o * a, i[u + 2] = l * a, i[u + 3] = 1;
        }
    const s = new Ze(i, t);
    return s.name = "neutral", s;
  }
}, za = `uniform vec3 scale;uniform vec3 offset;
...
outputColor=vec4(c,inputColor.a);}`, Nt = class extends I {
  ...
  set lut(e) {
    ...
    if (this.lut !== e && (i.get("lut").value = e, e !== null)) {
      ...
      if (t.clear(), t.set("LUT_SIZE", Math.min(r.width, r.height).toFixed(16)), t.set("LUT_TEXEL_WIDTH", (1 / r.width).toFixed(16)), t.set("LUT_TEXEL_HEIGHT", (1 / r.height).toFixed(16)), i.get("domainMin").value = null, i.get("domainMax").value = null, (e.type === j || e.type === _) && t.set("LUT_PRECISION_HIGH", "1"), r.width > r.height ? t.set("LUT_STRIP_HORIZONTAL", "1") : e instanceof Xe && t.set("LUT_3D", "1"), e instanceof Le) {
        const s = e.domainMin, n = e.domainMax;
        (s.x !== 0 || s.y !== 0 || s.z !== 0 || n.x !== 1 || n.y !== 1 || n.z !== 1) && (t.set("CUSTOM_INPUT_DOMAIN", "1"), i.get("domainMin").value = s.clone(), i.get("domainMax").value = n.clone());
      }
  ...
  configureTetrahedralInterpolation() {
    const e = this.lut;
    e !== null && (e.minFilter = P, e.magFilter = P, this.tetrahedralInterpolation && (e instanceof Xe ? (e.minFilter = B, e.magFilter = B) : console.warn("Tetrahedral interpolation requires a 3D texture")), e.needsUpdate = !0);
  }
  /**
...
}, ka = `void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){vec3 noise=vec3(rand(uv*(1.0+time)));
#ifdef PREMULTIPLY
...
outputColor=vec4(noise,inputColor.a);
  ...
  constructor({ blendFunction: e = g.SCREEN, premultiply: t = !1 } = {}) {
    super("NoiseEffect", ka, { blendFunction: e }), this.premultiply = t;
  }
  /**
...
#endif
float depthTest=(-vViewZ>-viewZ)?1.0:0.0;gl_FragColor.rg=vec2(0.0,depthTest);}`, Wa = `#include <common>
...
#include <clipping_planes_vertex>
  ...
  constructor(e = null, t) {
    super({
      ...
      fragmentShader: Va,
      vertexShader: Wa
    }), this.depthBuffer = e, this.depthPacking = re, this.copyCameraSettings(t);
  }
  /**
   * The depth buffer.
   *
  ...
  constructor(e, t, {
    ...
    super("DepthPass"), this.needsSwap = !1, this.renderPass = new He(e, t, new Qi({
      depthPacking: re
    }));
    const l = this.renderPass;
    l.skipShadowMapUpdate = !0, l.ignoreBackground = !0;
    const u = l.clearPass;
    u.overrideClearColor = new H(16777215), u.overrideClearAlpha = 1, this.renderTarget = i, this.renderTarget === void 0 && (this.renderTarget = new T(1, 1, {
      minFilter: B,
      magFilter: B
    }), this.renderTarget.texture.name = "DepthPass.Target");
    const f = this.resolution = new x(this, n, o, r);
...
}, Xa = `uniform lowp sampler2D edgeTexture;uniform lowp sampler2D maskTexture;uniform vec3 visibleEdgeColor;uniform vec3 hiddenEdgeColor;uniform float pulse;uniform float edgeStrength;
#ifdef USE_PATTERN
...
outputColor=vec4(color,max(alpha,inputColor.a));
#endif
}`, Za = "uniform float patternScale;varying vec2 vUvPattern;void mainSupport(const in vec2 uv){vUvPattern=uv*vec2(aspect,1.0)*patternScale;}", ja = class extends I {
  /**
  ...
  constructor(e, t, {
    ...
    super("OutlineEffect", Xa, {
      uniforms: /* @__PURE__ */ new Map([
        ["maskTexture", new c(null)],
        ["edgeTexture", new c(null)],
        ["edgeStrength", new c(s)],
        ["visibleEdgeColor", new c(new H(o))],
        ["hiddenEdgeColor", new c(new H(l))],
        ["pulse", new c(1)],
    ...
    }), this.blendMode.blendFunction = i, this.patternTexture = r, this.xRay = h, this.scene = e, this.camera = t, this.renderTargetMask = new T(1, 1), this.renderTargetMask.samples = d, this.renderTargetMask.texture.name = "Outline.Mask", this.uniforms.get("maskTexture").value = this.renderTargetMask.texture, this.renderTargetOutline = new T(1, 1, { depthBuffer: !1 }), this.renderTargetOutline.texture.name = "Outline.Edges", this.uniforms.get("edgeTexture").value = this.renderTargetOutline.texture, this.clearPass = new pe(), this.clearPass.overrideClearColor = new H(0), this.clearPass.overrideClearAlpha = 1, this.depthPass = new Pt(e, t), this.maskPass = new He(e, t, new Ai(this.depthPass.texture, t));
    const S = this.maskPass.clearPass;
    S.overrideClearColor = new H(16777215), S.overrideClearAlpha = 1, this.blurPass = new ve({ resolutionScale: v, resolutionX: E, resolutionY: C, kernelSize: u }), this.blurPass.enabled = f;
    const D = this.blurPass.resolution;
    D.addEventListener("change", ($) => this.setSize(D.baseWidth, D.baseHeight)), this.outlinePass = new J(new gt());
    const Y = this.outlinePass.fullscreenMaterial;
    Y.inputBuffer = this.renderTargetMask.texture, this.time = 0, this.forceUpdate = !0, this.selection = new Et(), this.pulseSpeed = n;
  }
  set mainScene(e) {
  ...
  set patternTexture(e) {
    e !== null ? (e.wrapS = e.wrapT = de, this.defines.set("USE_PATTERN", "1"), this.setVertexShader(Za)) : (this.defines.delete("USE_PATTERN"), this.setVertexShader(null)), this.uniforms.get("patternTexture").value = e, this.setChanged();
  }
  /**
   ...
   */
  update(e, t, i) {
    const r = this.scene, a = this.camera, s = this.selection, o = this.uniforms.get("pulse"), l = r.background, u = a.layers.mask;
    (this.forceUpdate || s.size > 0) && (r.background = null, o.value = 1, this.pulseSpeed > 0 && (o.value = Math.cos(this.time * this.pulseSpeed * 10) * 0.375 + 0.625), this.time += i, s.setVisible(!1), this.depthPass.render(e), s.setVisible(!0), a.layers.set(s.layer), this.maskPass.render(e, this.renderTargetMask), a.layers.mask = u, r.background = l, this.outlinePass.render(e, null, this.renderTargetOutline), this.blurPass.enabled && this.blurPass.render(e, this.renderTargetOutline, this.renderTargetOutline)), this.forceUpdate = s.size > 0;
  }
  /**
   * Updates the size of internal render targets.
   *
   ...
   */
  initialize(e, t, i) {
    this.blurPass.initialize(e, t, W), i !== void 0 && (this.depthPass.initialize(e, t, i), this.maskPass.initialize(e, t, i), this.outlinePass.initialize(e, t, i));
  }
}, Ja = "uniform bool active;uniform vec4 d;void mainUv(inout vec2 uv){if(active){uv=d.xy*(floor(uv*d.zw)+0.5);}}", qa = class extends I {
  /**
  ...
  setSize(e, t) {
    const i = this.resolution;
    i.set(e, t);
    const r = this.granularity, a = r / i.x, s = r / i.y;
    this.uniforms.get("d").value.set(a, s, 1 / a, 1 / s);
  }
}, _a = `uniform float focus;uniform float focalLength;uniform float fStop;uniform float maxBlur;uniform float luminanceThreshold;uniform float luminanceGain;uniform float bias;uniform float fringe;
#ifdef MANUAL_DOF
uniform vec4 dof;
#endif
#ifdef PENTAGON
...
#endif
outputColor=vec4(color,inputColor.a);}`, $a = class extends I {
  /**
   * Constructs a new bokeh effect.
   *
   * @param {Object} [options] - The options.
  ...
  set manualDoF(e) {
    this.manualDoF !== e && (e ? (this.defines.set("MANUAL_DOF", "1"), this.uniforms.get("dof").value = new Fe(0.2, 1, 0.2, 2)) : (this.defines.delete("MANUAL_DOF"), this.uniforms.get("dof").value = null), this.setChanged());
  }
  /**
...
y+=time*scrollSpeed;
#endif
vec2 sl=vec2(sin(y*count),cos(y*count));outputColor=vec4(sl.xyx,inputColor.a);}`, ts = class extends I {
  /**
...
}, is = "uniform bool active;uniform vec2 center;uniform float waveSize;uniform float radius;uniform float maxRadius;uniform float amplitude;varying float vSize;void mainUv(inout vec2 uv){if(active){vec2 aspectCorrection=vec2(aspect,1.0);vec2 difference=uv*aspectCorrection-center*aspectCorrection;float distance=sqrt(dot(difference,difference))*vSize;if(distance>radius){if(distance<radius+waveSize){float angle=(distance-radius)*PI2/waveSize;float cosSin=(1.0-cos(angle))*0.5;float extent=maxRadius+waveSize;float decay=max(extent-distance*distance,0.0)/extent;uv-=((cosSin*amplitude*difference)/distance)*decay;}}}}", rs = "uniform float size;uniform float cameraDistance;varying float vSize;void mainSupport(){vSize=(0.1*cameraDistance)/size;}", as = Math.PI * 0.5, Ie = /* @__PURE__ */ new F(), Ht = /* @__PURE__ */ new F(), ss = class extends I {
  /**
   ...
   */
  update(e, t, i) {
    const r = this.position, a = this.camera, s = this.uniforms, n = s.get("active");
    if (this.active) {
      const o = s.get("waveSize").value;
      a.getWorldDirection(Ie), Ht.copy(a.position).sub(r), n.value = Ie.angleTo(Ht) > as, n.value && (s.get("cameraDistance").value = a.position.distanceTo(r), Ie.copy(r).project(a), this.screenPosition.set((Ie.x + 1) * 0.5, (Ie.y + 1) * 0.5)), this.time += i * this.speed;
      const l = this.time - o;
      s.get("radius").value = l, l >= (s.get("maxRadius").value + o) * 2 && (this.active = !1, n.value = !1);
    }
  }
}, ns = class extends fi {
  /**
   ...
   */
  constructor(e, t, i) {
    super(i), this.setAttributes(this.getAttributes() | Q.DEPTH), this.camera = t, this.depthPass = new Pt(e, t), this.clearPass = new pe(!0, !1, !1), this.clearPass.overrideClearColor = new H(0), this.depthMaskPass = new J(new Mt());
    const r = this.depthMaskMaterial;
    r.copyCameraSettings(t), r.depthBuffer1 = this.depthPass.texture, r.depthPacking1 = re, r.depthMode = dt, this.renderTargetMasked = new T(1, 1, { depthBuffer: !1 }), this.renderTargetMasked.texture.name = "Bloom.Masked", this.selection = new Et(), this._inverted = !1, this._ignoreBackground = !1;
  }
  set mainScene(e) {
  ...
  set inverted(e) {
    this._inverted = e, this.depthMaskMaterial.depthMode = e ? _t : dt;
  }
  /**
   * Indicates whether the mask is inverted.
   *
  ...
  set ignoreBackground(e) {
    this._ignoreBackground = e, this.depthMaskMaterial.maxDepthStrategy = e ? ye.DISCARD_MAX_DEPTH : ye.KEEP_MAX_DEPTH;
  }
  /**
   ...
   */
  update(e, t, i) {
    const r = this.camera, a = this.selection, s = this.inverted;
    let n = t;
    if (this.ignoreBackground || !s || a.size > 0) {
      const o = r.layers.mask;
      r.layers.set(a.layer), this.depthPass.render(e), r.layers.mask = o, n = this.renderTargetMasked, this.clearPass.render(e, n), this.depthMaskPass.render(e, t, n);
    }
    super.update(e, n, i);
  }
  /**
...
}, os = "uniform vec3 weightsR;uniform vec3 weightsG;uniform vec3 weightsB;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){vec3 color=vec3(dot(inputColor.rgb,weightsR),dot(inputColor.rgb,weightsG),dot(inputColor.rgb,weightsB));outputColor=vec4(color,inputColor.a);}", ls = class extends I {
  /**
  ...
  constructor({ blendFunction: e, intensity: t = 1 } = {}) {
    super("SepiaEffect", os, {
      blendFunction: e,
      uniforms: /* @__PURE__ */ new Map([
        ["weightsR", new c(new F(0.393, 0.769, 0.189))],
        ["weightsG", new c(new F(0.349, 0.686, 0.168))],
        ["weightsB", new c(new F(0.272, 0.534, 0.131))]
      ])
    });
  }
  /**
...
}, us = `varying vec2 vUv;varying vec2 vUv0;varying vec2 vUv1;
...
#endif
gl_Position=vec4(position.xy,1.0,1.0);}`, mt = class extends w {
  /**
...
vec2 d;vec3 coords;coords.x=searchXLeft(vOffset[0].xy,vOffset[2].x);coords.y=vOffset[1].y;d.x=coords.x;float e1=texture2D(inputBuffer,coords.xy).r;coords.z=searchXRight(vOffset[0].zw,vOffset[2].y);d.y=coords.z;d=round(resolution.xx*d+-vPixCoord.xx);vec2 sqrtD=sqrt(abs(d));float e2=sampleLevelZeroOffset(inputBuffer,coords.zy,vec2(1,0)).r;weights.rg=area(sqrtD,e1,e2,subsampleIndices.y);coords.y=vUv.y;detectHorizontalCornerPattern(weights.rg,coords.xyzy,d);
  ...
  constructor({
    ...
    let a, s;
    arguments.length > 1 && (a = arguments[0], s = arguments[1], arguments.length > 2 && (t = arguments[2]), arguments.length > 3 && (i = arguments[3])), this.renderTargetEdges = new T(1, 1, { depthBuffer: !1 }), this.renderTargetEdges.texture.name = "SMAA.Edges", this.renderTargetWeights = this.renderTargetEdges.clone(), this.renderTargetWeights.texture.name = "SMAA.Weights", this.uniforms.get("weightMap").value = this.renderTargetWeights.texture, this.clearPass = new pe(!0, !1, !1), this.clearPass.overrideClearColor = new H(0), this.clearPass.overrideClearAlpha = 1, this.edgeDetectionPass = new J(new mt()), this.edgeDetectionMaterial.edgeDetectionMode = i, this.edgeDetectionMaterial.predicationMode = r, this.weightsPass = new J(new xi());
    const n = new Oe();
    n.onLoad = () => {
      const o = new je(a);
      o.name = "SMAA.Search", o.magFilter = B, o.minFilter = B, o.generateMipmaps = !1, o.needsUpdate = !0, o.flipY = !0, this.weightsMaterial.searchTexture = o;
      const l = new je(s);
      l.name = "SMAA.Area", l.magFilter = P, l.minFilter = P, l.generateMipmaps = !1, l.needsUpdate = !0, l.flipY = !1, this.weightsMaterial.areaTexture = l, this.dispatchEvent({ type: "load" });
    }, n.itemStart("search"), n.itemStart("area"), a !== void 0 && s !== void 0 ? (n.itemEnd("search"), n.itemEnd("area")) : typeof Image < "u" && (a = new Image(), s = new Image(), a.addEventListener("load", () => n.itemEnd("search")), s.addEventListener("load", () => n.itemEnd("area")), a.src = At, s.src = xt), this.applyPreset(t);
  }
  /**
   * The edges texture.
   *
...
ao=clamp(1.0-pow(1.0-ao,abs(intensity)),0.0,1.0);
#endif
}gl_FragColor.r=ao;}`, ms = "uniform vec2 noiseScale;varying vec2 vUv;varying vec2 vUv2;void main(){vUv=position.xy*0.5+0.5;vUv2=vUv*noiseScale;gl_Position=vec4(position.xy,1.0,1.0);}", Di = class extends w {
  /**
  ...
  constructor(e) {
    super({
      ...
      uniforms: {
        ...
        inverseProjectionMatrix: new c(new L()),
        projectionMatrix: new c(new L()),
        texelSize: new c(new p()),
   ...
   */
  copyCameraSettings(e) {
    e && (this.uniforms.cameraNearFar.value.set(e.near, e.far), this.uniforms.projectionMatrix.value.copy(e.projectionMatrix), this.uniforms.inverseProjectionMatrix.value.copy(e.projectionMatrix).invert(), e instanceof Pe ? this.defines.PERSPECTIVE_CAMERA = "1" : delete this.defines.PERSPECTIVE_CAMERA, this.needsUpdate = !0);
  }
  /**
   * Sets the size of this object.
   *
...
gl_FragColor=vec4(n[index],d[index]);}`, xs = "uniform vec2 texelSize;varying vec2 vUv0;varying vec2 vUv1;varying vec2 vUv2;varying vec2 vUv3;void main(){vec2 uv=position.xy*0.5+0.5;vUv0=uv;vUv1=vec2(uv.x,uv.y+texelSize.y);vUv2=vec2(uv.x+texelSize.x,uv.y);vUv3=uv+texelSize;gl_Position=vec4(position.xy,1.0,1.0);}", wi = class extends w {
  ...
  constructor({
    ...
    const n = new wi();
    n.normalBuffer = e, this.fullscreenMaterial = n, this.needsDepthTexture = !0, this.needsSwap = !1, this.renderTarget = new T(1, 1, {
      minFilter: B,
      magFilter: B,
      depthBuffer: !1,
      type: j
    }), this.renderTarget.texture.name = "DepthDownsamplingPass.Target", this.renderTarget.texture.generateMipmaps = !1;
    const o = this.resolution = new x(this, a, s, t);
...
outputColor=vec4(vec3(1.0-ao),inputColor.a);
  ...
  constructor(e, t, {
    ...
    const ae = this.resolution = new x(this, ge, me, te);
    ae.addEventListener("change", (Ge) => this.setSize(ae.baseWidth, ae.baseHeight)), this.camera = e, this.depthDownsamplingPass = new Ti({ normalBuffer: t, resolutionScale: te }), this.depthDownsamplingPass.enabled = s === null, this.ssaoPass = new J(new Di(e));
    const ue = new et(zt, zt, N);
    ue.wrapS = ue.wrapT = de;
    const G = this.ssaoMaterial;
    G.normalBuffer = t, G.noiseTexture = ue, G.minRadiusScale = m, G.samples = r, G.radius = C, G.rings = a, G.fade = Y, G.bias = D, G.distanceThreshold = h, G.distanceFalloff = d, G.proximityThreshold = v, G.proximityFalloff = A, o !== void 0 && (G.worldDistanceThreshold = o), l !== void 0 && (G.worldDistanceFalloff = l), u !== void 0 && (G.worldProximityThreshold = u), f !== void 0 && (G.worldProximityFalloff = f), s !== null && (this.ssaoMaterial.normalDepthBuffer = s, this.defines.set("NORMAL_DEPTH", "1")), this.depthAwareUpsampling = n, this.color = $;
  }
  set mainCamera(e) {
  ...
  set color(e) {
    ...
    e !== null ? i.has("COLORIZE") ? t.get("color").value.set(e) : (i.set("COLORIZE", "1"), t.get("color").value = new H(e), this.setChanged()) : i.has("COLORIZE") && (i.delete("COLORIZE"), t.get("color").value = null, this.setChanged());
  }
  /**
...
}, Ts = `#ifdef TEXTURE_PRECISION_HIGH
uniform mediump sampler2D map;
#else
uniform lowp sampler2D map;
#endif
...
vUv2=(uvTransform*vec3(uv,1.0)).xy;
  ...
  set texture(e) {
    ...
    t !== e && (i.get("map").value = e, i.get("uvTransform").value = e.matrix, r.delete("TEXTURE_PRECISION_HIGH"), e !== null && (e.matrixAutoUpdate ? (r.set("UV_TRANSFORM", "1"), this.setVertexShader(Ss)) : (r.delete("UV_TRANSFORM"), this.setVertexShader(null)), e.type !== W && r.set("TEXTURE_PRECISION_HIGH", "1"), (t === null || t.type !== e.type || t.encoding !== e.encoding) && this.setChanged()));
  }
  /**
   * Returns the texture.
   *
  ...
  setTextureSwizzleRGBA(e, t = e, i = e, r = e) {
    const a = "rgba";
    let s = "";
    (e !== ce.RED || t !== ce.GREEN || i !== ce.BLUE || r !== ce.ALPHA) && (s = [".", a[e], a[t], a[i], a[r]].join("")), this.defines.set("TEXEL", "texel" + s), this.setChanged();
  }
  /**
   * Updates this effect.
   *
...
#include <colorspace_fragment>
  ...
  constructor({
    ...
    super(), this.fragmentShader = Cs, this.vertexShader = ys, this.kernelSize = e, this.uniforms.aspect = new c(1), this.uniforms.rotation = new c(new p()), this.uniforms.maskParams = new c(new Fe()), this._offset = t, this._focusArea = r, this._feather = a, this.rotation = i, this.updateParams();
  }
  /**
  ...
  constructor({
    ...
    focusArea: i = 0.4,
    feather: r = 0.3,
    kernelSize: a = ee.MEDIUM,
    resolutionScale: s = 0.5,
    resolutionX: n = x.AUTO_SIZE,
    resolutionY: o = x.AUTO_SIZE
  } = {}) {
    super({ kernelSize: a, resolutionScale: s, resolutionX: n, resolutionY: o }), this.blurMaterial = new Si({ kernelSize: a, offset: e, rotation: t, focusArea: i, feather: r });
  }
...
uniform vec2 maskParams;varying vec2 vUv2;float linearGradientMask(const in float x){return step(maskParams.x,x)-step(maskParams.y,x);}void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){float mask=linearGradientMask(vUv2.y);vec4 texel=texture2D(map,uv);outputColor=mix(texel,inputColor,mask);}`, Bs = "uniform vec2 rotation;varying vec2 vUv2;void mainSupport(const in vec2 uv){vUv2=(uv-0.5)*2.0*vec2(aspect,1.0);vUv2=vec2(dot(rotation,vUv2),dot(rotation,vec2(vUv2.y,-vUv2.x)));}", Ps = class extends I {
  ...
  constructor({
    ...
    const u = this.resolution = new x(this, o, l, n);
...
outputColor=vec4(toneMapping(inputColor.rgb),inputColor.a);
  ...
  constructor({
    blendFunction: e = g.SRC,
    adaptive: t = !1,
    mode: i = t ? Z.REINHARD2_ADAPTIVE : Z.AGX,
    resolution: r = 256,
    maxLuminance: a = 4,
    whitePoint: s = a,
    middleGrey: n = 0.6,
  ...
  set mode(e) {
    ...
    this.adaptiveLuminancePass.enabled = e === Z.REINHARD2_ADAPTIVE, this.setChanged();
  }
  /**
   ...
   */
  get adaptive() {
    return this.mode === Z.REINHARD2_ADAPTIVE;
  }
  set adaptive(e) {
    this.mode = e ? Z.REINHARD2_ADAPTIVE : Z.REINHARD2;
  }
  /**
   * The luminance adaptation rate.
   *
...
#endif
outputColor=vec4(color,inputColor.a);}`, Fs = class extends I {
  /**
  ...
  constructor({
    blendFunction: e,
    eskil: t = !1,
    technique: i = t ? Se.ESKIL : Se.DEFAULT,
    offset: r = 0.5,
    darkness: a = 0.5
  } = {}) {
   ...
   */
  get eskil() {
    return this.technique === Se.ESKIL;
  }
  /**
   * Indicates whether Eskil's Vignette technique is enabled.
   *
   ...
   */
  set eskil(e) {
    this.technique = e ? Se.ESKIL : Se.DEFAULT;
  }
  /**
  ...
  load(e, t = () => {
    ...
    const a = this.manager, s = new Oe(), n = new $t(s);
    return n.setPath(this.path), n.setResponseType("text"), new Promise((o, l) => {
      ...
      }, a.itemStart(e), n.load(e, (u) => {
        try {
          const f = this.parse(u);
          a.itemEnd(e), t(f), o(f);
        } catch (f) {
          console.error(f), s.onError(e);
        }
      }, i);
    });
  }
  ...
  parse(e) {
    ...
    const a = r[0].trim().split(/\s+/g).map((v) => Number(v)), s = a[1] - a[0], n = a.length, o = n ** 2;
    ...
    for (; (r = i.exec(e)) !== null; ) {
      ...
      u = Math.max(u, v, A, m);
      const E = f % n, C = Math.floor(f / n) % n, S = Math.floor(f / o) % n, D = (E * o + C * n + S) * 4;
   ...
   */
  parse(e) {
    const t = /TITLE +"([^"]*)"/, i = /LUT_3D_SIZE +(\d+)/, r = /DOMAIN_MIN +([\d.]+) +([\d.]+) +([\d.]+)/, a = /DOMAIN_MAX +([\d.]+) +([\d.]+) +([\d.]+)/, s = /^([\d.e+-]+) +([\d.e+-]+) +([\d.e+-]+) *$/gm;
    let n = t.exec(e);
    const o = n !== null ? n[1] : null;
    if (n = i.exec(e), n === null)
      throw new Error("Missing LUT_3D_SIZE information");
    const l = Number(n[1]), u = new Float32Array(l ** 3 * 4), f = new F(0, 0, 0), h = new F(1, 1, 1);
    if (n = r.exec(e), n !== null && f.set(Number(n[1]), Number(n[2]), Number(n[3])), n = a.exec(e), n !== null && h.set(Number(n[1]), Number(n[2]), Number(n[3])), f.x > h.x || f.y > h.y || f.z > h.z)
  ...
  load(e = () => {
    ...
    const i = this.manager, r = new Oe();
    return new Promise((a, s) => {
      const n = new Image(), o = new Image();
      r.onError = (l) => {
        i.itemError(l), t !== null ? (t(`Failed to load ${l}`), a()) : s(`Failed to load ${l}`);
      }, r.onLoad = () => {
        const l = [n, o];
        e(l), a(l);
      ...
      }), i.itemStart("smaa-search"), i.itemStart("smaa-area"), r.itemStart("smaa-search"), r.itemStart("smaa-area"), n.src = At, o.src = xt;
    });
  }
...
gl_Position=vec4(position.xy,1.0,1.0);}`, Mi = class extends w {
  ...
  set worldDistanceThreshold(e) {
    const t = ne(-e, this.near, this.far);
...
#endif
#include <dithering_fragment>
}`, Vs = "uniform vec2 resolution;uniform vec2 texelSize;uniform float cameraNear;uniform float cameraFar;uniform float aspect;uniform float time;varying vec2 vUv;VERTEX_HEAD void main(){vUv=position.xy*0.5+0.5;VERTEX_MAIN_SUPPORT gl_Position=vec4(position.xy,1.0,1.0);}", Pi = class extends w {
  /**
   ...
   */
  setShaderParts(e) {
    return this.fragmentShader = Qs.replace(M.FRAGMENT_HEAD, e.get(M.FRAGMENT_HEAD) || "").replace(M.FRAGMENT_MAIN_UV, e.get(M.FRAGMENT_MAIN_UV) || "").replace(M.FRAGMENT_MAIN_IMAGE, e.get(M.FRAGMENT_MAIN_IMAGE) || ""), this.vertexShader = Vs.replace(M.VERTEX_HEAD, e.get(M.VERTEX_HEAD) || "").replace(M.VERTEX_MAIN_SUPPORT, e.get(M.VERTEX_MAIN_SUPPORT) || ""), this.needsUpdate = !0, this;
  }
  /**
...
}, Ws = `#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D inputBuffer;
#else
uniform lowp sampler2D inputBuffer;
#endif
...
#include <colorspace_fragment>
}`, Ys = "uniform vec2 texelSize;uniform vec2 direction;uniform float scale;varying vec2 vOffset;varying vec2 vUv;void main(){vOffset=direction*texelSize*scale;vUv=position.xy*0.5+0.5;gl_Position=vec4(position.xy,1.0,1.0);}", Ii = class extends w {
  /**
   * Constructs a new convolution material.
   *
   * @param {Object} [options] - The options.
   ...
   */
  generateKernel(e) {
    const t = new si(e), i = t.linearSteps, r = new Float64Array(i * 2);
    for (let a = 0, s = 0; a < i; ++a)
      r[s++] = t.linearOffsets[a], r[s++] = t.linearWeights[a];
  ...
  constructor({
    ...
    super("BoxBlurPass"), this.needsDepthTexture = i, this.renderTargetA = new T(1, 1, { depthBuffer: !1 }), this.renderTargetA.texture.name = "Blur.Target.A", this.renderTargetB = new T(1, 1, { depthBuffer: !1 }), this.renderTargetB.texture.name = "Blur.Target.B", this.blurMaterial = new Mi({ bilateral: i, kernelSize: e }), this.copyMaterial = new Ne();
    const n = this.resolution = new x(this, a, s, r);
   ...
   */
  render(e, t, i, r, a) {
    const s = this.scene, n = this.camera, o = this.renderTargetA, l = this.renderTargetB, u = this.blurMaterial;
    this.fullscreenMaterial = u;
    let f = t;
    for (let h = 0, d = Math.max(this.iterations, 1); h < d; ++h) {
      const v = h & 1 ? l : o;
      u.inputBuffer = f.texture, e.setRenderTarget(v), e.render(s, n), f = v;
    }
    this.copyMaterial.inputBuffer = f.texture, this.fullscreenMaterial = this.copyMaterial, e.setRenderTarget(this.renderToScreen ? null : i), e.render(s, n);
  }
  /**
   * Updates the size of this pass.
   *
   ...
   */
  initialize(e, t, i) {
    e !== null && (this.blurMaterial.maxVaryingVectors = e.capabilities.maxVaryings), i !== void 0 && (this.renderTargetA.texture.type = i, this.renderTargetB.texture.type = i, i !== W ? this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1" : e !== null && e.outputColorSpace === y && (this.renderTargetA.texture.colorSpace = y, this.renderTargetB.texture.colorSpace = y));
  }
}, Dt = class extends O {
  /**
...
}, Xs = Number(Be.replace(/\D+/g, "")), he = 255 / 256, Zs = new Float32Array([
  he / 256 ** 3,
  he / 256 ** 2,
  he / 256,
  he
...
function Js(e) {
  const t = Xs >= 167 ? js : Zs;
  return (e[0] * t[0] + e[1] * t[1] + e[2] * t[2] + e[3] * t[3]) / 255;
}
var qs = class extends Dt {
  /**
   ...
   */
  constructor({ depthPacking: e = re, mode: t = Ee.SINGLE } = {}) {
    if (e !== re && e !== V)
      throw new Error(`Unsupported depth packing: ${e}`);
    super({ depthPacking: e }), this.name = "DepthPickingPass", this.fullscreenMaterial.mode = t, this.pixelBuffer = e === re ? new Uint8Array(4) : new Float32Array(4), this.callback = null;
  }
  /**
   ...
   */
  render(e, t, i, r, a) {
    const s = this.fullscreenMaterial, n = s.mode;
    if (n === Ee.FULL && super.render(e), this.callback !== null) {
      const o = this.renderTarget, l = this.pixelBuffer, u = o.texture.type !== j;
      let f = 0, h = 0;
      if (n === Ee.SINGLE)
        super.render(e);
      else {
        const d = s.texelPosition;
   ...
   */
  setSize(e, t) {
    this.fullscreenMaterial.mode === Ee.FULL && super.setSize(e, t);
  }
};
function Gt(e, t, i) {
  for (const r of t) {
    const a = "$1" + e + r.charAt(0).toUpperCase() + r.slice(1), s = new RegExp("([^\\.])(\\b" + r + "\\b)", "g");
    for (const n of i.entries())
      n[1] !== null && i.set(n[0], n[1].replace(s, a));
  }
}
function _s(e, t, i) {
  let r = t.getFragmentShader(), a = t.getVertexShader();
  const s = r !== void 0 && /mainImage/.test(r), n = r !== void 0 && /mainUv/.test(r);
  if (i.attributes |= t.getAttributes(), r === void 0)
    throw new Error(`Missing fragment shader (${t.name})`);
  if (n && i.attributes & Q.CONVOLUTION)
    ...
    throw new Error(`Could not find mainImage or mainUv function (${t.name})`);
  {
    ...
    let u = l.get(M.FRAGMENT_HEAD) || "", f = l.get(M.FRAGMENT_MAIN_UV) || "", h = l.get(M.FRAGMENT_MAIN_IMAGE) || "", d = l.get(M.VERTEX_HEAD) || "", v = l.get(M.VERTEX_MAIN_SUPPORT) || "";
...
`;
      for (const D of a.matchAll(/(?:varying\s+\w+\s+([\S\s]*?);)/g))
        for (const Y of D[1].split(/\s*,\s*/))
          i.varyings.add(Y), A.add(Y), m.add(Y);
    ...
    const C = t.blendMode;
    if (i.blendModes.set(C.blendFunction, C), s) {
	...
	`), t.outputColorSpace !== tt ? i.colorSpace = t.outputColorSpace : t.inputColorSpace !== null && (i.colorSpace = t.inputColorSpace);
      ...
      h += `${e}MainImage(color0, UV, `, i.attributes & Q.DEPTH && S.test(r) && (h += "depth, ", i.readDepth = !0), h += `color1);
	`;
...
`;
    ...
    if (u += r + `
`, a !== null && (d += a + `
`), l.set(M.FRAGMENT_HEAD, u), l.set(M.FRAGMENT_MAIN_UV, f), l.set(M.FRAGMENT_MAIN_IMAGE, h), l.set(M.VERTEX_HEAD, d), l.set(M.VERTEX_MAIN_SUPPORT, v), t.extensions !== null)
...
var $s = class extends O {
  ...
  updateMaterial() {
    ...
    for (const n of this.effects)
      if (n.blendMode.blendFunction === g.DST)
        e.attributes |= n.getAttributes() & Q.DEPTH;
      else {
        if (e.attributes & n.getAttributes() & Q.CONVOLUTION)
          throw new Error(`Convolution effects cannot be merged (${n.name})`);
        _s("e" + t++, n, e);
      }
    let i = e.shaderParts.get(M.FRAGMENT_HEAD), r = e.shaderParts.get(M.FRAGMENT_MAIN_IMAGE), a = e.shaderParts.get(M.FRAGMENT_MAIN_UV);
    const s = /\bblend\b/g;
    for (const n of e.blendModes.values())
      i += n.getShaderCode().replace(s, `blend${n.blendFunction}`) + `
`;
    e.attributes & Q.DEPTH ? (e.readDepth && (r = `float depth = readDepth(UV);
...
` + a, e.defines.set("UV", "transformedUv")) : e.defines.set("UV", "vUv"), e.shaderParts.set(M.FRAGMENT_HEAD, i), e.shaderParts.set(M.FRAGMENT_MAIN_IMAGE, r), e.shaderParts.set(M.FRAGMENT_MAIN_UV, a);
...
#`));
  ...
  render(e, t, i, r, a) {
    ...
    if (!this.skipRendering || this.renderToScreen) {
      const s = this.fullscreenMaterial;
      s.inputBuffer = t.texture, s.time += r * this.timeScale, e.setRenderTarget(this.renderToScreen ? null : i), e.render(this.scene, this.camera);
    }
  }
  /**
   * Updates the size of this pass.
  ...
  initialize(e, t, i) {
    ...
    for (const r of this.effects)
      r.initialize(e, t, i);
    this.updateMaterial(), i !== void 0 && i !== W && (this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1");
  }
  /**
  ...
  constructor({
    ...
    super("GaussianBlurPass"), this.renderTargetA = new T(1, 1, { depthBuffer: !1 }), this.renderTargetA.texture.name = "Blur.Target.A", this.renderTargetB = this.renderTargetA.clone(), this.renderTargetB.texture.name = "Blur.Target.B", this.blurMaterial = new Ii({ kernelSize: e }), this.copyMaterial = new Ne(), this.copyMaterial.inputBuffer = this.renderTargetB.texture;
    const s = this.resolution = new x(this, r, a, i);
    s.addEventListener("change", (n) => this.setSize(s.baseWidth, s.baseHeight)), this.iterations = t;
  }
  /**
   * Renders the blur.
   *
  ...
  render(e, t, i, r, a) {
    ...
    let f = t;
    for (let h = 0, d = Math.max(this.iterations, 1); h < d; ++h)
      u.direction.set(1, 0), u.inputBuffer = f.texture, e.setRenderTarget(o), e.render(s, n), u.direction.set(0, 1), u.inputBuffer = o.texture, e.setRenderTarget(l), e.render(s, n), h === 0 && d > 1 && (f = l);
    this.fullscreenMaterial = this.copyMaterial, e.setRenderTarget(this.renderToScreen ? null : i), e.render(s, n);
  }
  /**
   * Updates the size of this pass.
   *
  ...
  constructor(e, t, {
    ...
    super("NormalPass"), this.needsSwap = !1, this.renderPass = new He(e, t, new Wi());
    const l = this.renderPass;
    l.ignoreBackground = !0, l.skipShadowMapUpdate = !0;
    const u = l.getClearPass();
    u.overrideClearColor = new H(7829503), u.overrideClearAlpha = 1, this.renderTarget = i, this.renderTarget === void 0 && (this.renderTarget = new T(1, 1, {
      minFilter: B,
      magFilter: B
...
function We(e, t, i, r) {
  const a = i[0] - t[0], s = i[1] - t[1], n = i[2] - t[2], o = e[0] - t[0], l = e[1] - t[1], u = e[2] - t[2], f = s * u - n * l, h = n * o - a * u, d = a * l - s * o, v = Math.sqrt(f * f + h * h + d * d), A = v * 0.5, m = f / v, E = h / v, C = d / v, S = -(e[0] * m + e[1] * E + e[2] * C), D = r[0] * m + r[1] * E + r[2] * C;
  return Math.abs(D + S) * A / 3;
}
function Re(e, t, i, r, a, s) {
  const n = (i + r * t + a * t * t) * 4;
  s[0] = e[n + 0], s[1] = e[n + 1], s[2] = e[n + 2];
}
function an(e, t, i, r, a, s) {
  const n = i * (t - 1), o = r * (t - 1), l = a * (t - 1), u = Math.floor(n), f = Math.floor(o), h = Math.floor(l), d = Math.ceil(n), v = Math.ceil(o), A = Math.ceil(l), m = n - u, E = o - f, C = l - h;
  if (u === n && f === o && h === l)
    Re(e, t, n, o, l, s);
  else {
    let S;
...
var sn = class {
   ...
   */
  static expand(e, t) {
    const i = Math.cbrt(e.length / 4), r = new Float32Array(3), a = new e.constructor(t ** 3 * 4), s = e instanceof Uint8Array ? 255 : 1, n = t ** 2, o = 1 / (t - 1);
    for (let l = 0; l < t; ++l)
      for (let u = 0; u < t; ++u)
        for (let f = 0; f < t; ++f) {
          const h = f * o, d = u * o, v = l * o, A = Math.round(f + u * t + l * n) * 4;
          an(e, i, h, d, v, r), a[A + 0] = r[0], a[A + 1] = r[1], a[A + 2] = r[2], a[A + 3] = s;
        }
    return a;
  }
}, Me = [
  new Float32Array(2),
  new Float32Array(2)
], xe = 16, ut = 20, De = 30, nn = 32, ct = new Float32Array([
  0,
  -0.25,
  0.25,
  -0.125,
...
function Vt(e) {
  const t = Me[0], i = Me[1], r = Math.sqrt(t[0] * 2) * 0.5, a = Math.sqrt(t[1] * 2) * 0.5, s = Math.sqrt(i[0] * 2) * 0.5, n = Math.sqrt(i[1] * 2) * 0.5, o = ln(e / nn);
  t[0] = Ye(r, t[0], o), t[1] = Ye(a, t[1], o), i[0] = Ye(s, i[0], o), i[1] = Ye(n, i[1], o);
}
function k(e, t, i, r, a, s) {
  const n = i - e, o = r - t, l = a, u = a + 1, f = t + o * (l - e) / n, h = t + o * (u - e) / n;
  if (l >= e && l < i || u > e && u <= i)
    if (Math.sign(f) === Math.sign(h) || Math.abs(f) < 1e-4 || Math.abs(h) < 1e-4) {
      const d = (f + h) / 2;
      d < 0 ? (s[0] = Math.abs(d), s[1] = 0) : (s[0] = 0, s[1] = Math.abs(d));
    } else {
      const d = -t * n / o + e, v = Math.trunc(d), A = d > e ? f * (d - v) / 2 : 0, m = d < i ? h * (1 - (d - v)) / 2 : 0;
      (Math.abs(A) > Math.abs(m) ? A : -m) < 0 ? (s[0] = Math.abs(A), s[1] = Math.abs(m)) : (s[0] = Math.abs(m), s[1] = Math.abs(A));
    }
  else
    s[0] = 0, s[1] = 0;
  return s;
...
function un(e, t, i, r, a) {
  const s = Me[0], n = Me[1], o = 0.5 + r, l = 0.5 + r - 1, u = t + i + 1;
  switch (e) {
    case 0: {
      a[0] = 0, a[1] = 0;
      break;
    ...
    case 1: {
      t <= i ? k(0, l, u / 2, 0, t, a) : (a[0] = 0, a[1] = 0);
      break;
    }
    case 2: {
      t >= i ? k(u / 2, 0, u, l, t, a) : (a[0] = 0, a[1] = 0);
      break;
    }
    case 3: {
      k(0, l, u / 2, 0, t, s), k(u / 2, 0, u, l, t, n), Vt(u), a[0] = s[0] + n[0], a[1] = s[1] + n[1];
      break;
    }
    case 4: {
      t <= i ? k(0, o, u / 2, 0, t, a) : (a[0] = 0, a[1] = 0);
      break;
    }
    case 5: {
      a[0] = 0, a[1] = 0;
    ...
    case 6: {
      Math.abs(r) > 0 ? (k(0, o, u, l, t, s), k(0, o, u / 2, 0, t, n), k(u / 2, 0, u, l, t, a), n[0] = n[0] + a[0], n[1] = n[1] + a[1], a[0] = (s[0] + n[0]) / 2, a[1] = (s[1] + n[1]) / 2) : k(0, o, u, l, t, a);
      break;
    }
    case 7: {
      k(0, o, u, l, t, a);
    ...
    case 8: {
      t >= i ? k(u / 2, 0, u, o, t, a) : (a[0] = 0, a[1] = 0);
      break;
    }
    case 9: {
      Math.abs(r) > 0 ? (k(0, l, u, o, t, s), k(0, l, u / 2, 0, t, n), k(u / 2, 0, u, o, t, a), n[0] = n[0] + a[0], n[1] = n[1] + a[1], a[0] = (s[0] + n[0]) / 2, a[1] = (s[1] + n[1]) / 2) : k(0, l, u, o, t, a);
      break;
    }
    case 10: {
      a[0] = 0, a[1] = 0;
    ...
    case 12: {
      k(0, o, u / 2, 0, t, s), k(u / 2, 0, u, o, t, n), Vt(u), a[0] = s[0] + n[0], a[1] = s[1] + n[1];
      break;
    }
    case 13: {
      k(0, l, u, o, t, a);
...
function Wt(e, t, i, r, a, s) {
  let n = 0;
  for (let o = 0; o < De; ++o)
    for (let l = 0; l < De; ++l) {
      const u = l / (De - 1), f = o / (De - 1);
      cn(e, t, i, r, a + u, s + f) && ++n;
    }
  return n / (De * De);
}
function R(e, t, i, r, a, s, n, o) {
  const l = Ri[e], u = l[0], f = l[1];
  return u > 0 && (t += n[0], i += n[1]), f > 0 && (r += n[0], a += n[1]), o[0] = 1 - Wt(t, i, r, a, 1 + s, 0 + s), o[1] = Wt(t, i, r, a, 1 + s, 1 + s), o;
}
function fn(e, t, i, r, a) {
  const s = Me[0], n = Me[1], o = t + i + 1;
  switch (e) {
    case 0: {
      R(e, 1, 1, 1 + o, 1 + o, t, r, s), R(e, 1, 0, 1 + o, 0 + o, t, r, n), a[0] = (s[0] + n[0]) / 2, a[1] = (s[1] + n[1]) / 2;
      break;
    }
    case 1: {
      R(e, 1, 0, 0 + o, 0 + o, t, r, s), R(e, 1, 0, 1 + o, 0 + o, t, r, n), a[0] = (s[0] + n[0]) / 2, a[1] = (s[1] + n[1]) / 2;
      break;
    }
    case 2: {
      R(e, 0, 0, 1 + o, 0 + o, t, r, s), R(e, 1, 0, 1 + o, 0 + o, t, r, n), a[0] = (s[0] + n[0]) / 2, a[1] = (s[1] + n[1]) / 2;
      break;
    }
    case 3: {
      R(e, 1, 0, 1 + o, 0 + o, t, r, a);
      break;
    }
    case 4: {
      R(e, 1, 1, 0 + o, 0 + o, t, r, s), R(e, 1, 1, 1 + o, 0 + o, t, r, n), a[0] = (s[0] + n[0]) / 2, a[1] = (s[1] + n[1]) / 2;
      break;
    }
    case 5: {
      R(e, 1, 1, 0 + o, 0 + o, t, r, s), R(e, 1, 0, 1 + o, 0 + o, t, r, n), a[0] = (s[0] + n[0]) / 2, a[1] = (s[1] + n[1]) / 2;
      break;
    }
    case 6: {
      R(e, 1, 1, 1 + o, 0 + o, t, r, a);
      break;
    }
    case 7: {
      R(e, 1, 1, 1 + o, 0 + o, t, r, s), R(e, 1, 0, 1 + o, 0 + o, t, r, n), a[0] = (s[0] + n[0]) / 2, a[1] = (s[1] + n[1]) / 2;
      break;
    }
    case 8: {
      R(e, 0, 0, 1 + o, 1 + o, t, r, s), R(e, 1, 0, 1 + o, 1 + o, t, r, n), a[0] = (s[0] + n[0]) / 2, a[1] = (s[1] + n[1]) / 2;
      break;
    }
    case 9: {
      R(e, 1, 0, 1 + o, 1 + o, t, r, a), R(e, 1, 0, 1 + o, 1 + o, t, r, a);
      break;
    }
    case 10: {
      R(e, 0, 0, 1 + o, 1 + o, t, r, s), R(e, 1, 0, 1 + o, 0 + o, t, r, n), a[0] = (s[0] + n[0]) / 2, a[1] = (s[1] + n[1]) / 2;
      break;
    }
    case 11: {
      R(e, 1, 0, 1 + o, 1 + o, t, r, s), R(e, 1, 0, 1 + o, 0 + o, t, r, n), a[0] = (s[0] + n[0]) / 2, a[1] = (s[1] + n[1]) / 2;
      break;
    }
    case 12: {
      R(e, 1, 1, 1 + o, 1 + o, t, r, a);
      break;
    }
    case 13: {
      R(e, 1, 1, 1 + o, 1 + o, t, r, s), R(e, 1, 0, 1 + o, 1 + o, t, r, n), a[0] = (s[0] + n[0]) / 2, a[1] = (s[1] + n[1]) / 2;
      break;
    }
    case 14: {
      R(e, 1, 1, 1 + o, 1 + o, t, r, s), R(e, 1, 1, 1 + o, 0 + o, t, r, n), a[0] = (s[0] + n[0]) / 2, a[1] = (s[1] + n[1]) / 2;
      break;
    }
    case 15: {
      R(e, 1, 1, 1 + o, 1 + o, t, r, s), R(e, 1, 0, 1 + o, 0 + o, t, r, n), a[0] = (s[0] + n[0]) / 2, a[1] = (s[1] + n[1]) / 2;
...
function Yt(e, t, i) {
  ...
  for (let a = 0, s = e.length; a < s; ++a) {
    const n = e[a], o = n.data, l = n.width;
    for (let u = 0; u < l; ++u)
      for (let f = 0; f < l; ++f) {
        i ? un(a, f, u, t, r) : fn(a, f, u, t, r);
        const h = (u * l + f) * 2;
        o[h] = r[0] * 255, o[h + 1] = r[1] * 255;
      }
  }
}
function Kt(e, t, i, r, a, s, n) {
  const o = n.data, l = n.width;
  for (let u = 0, f = i.length; u < f; ++u) {
    const h = r[u], d = i[u], v = d.data, A = d.width;
    for (let m = 0; m < a; ++m)
      for (let E = 0; E < a; ++E) {
        const C = h[0] * a + e + E, D = ((h[1] * a + t + m) * l + C) * 4, Y = s ? (m * m * A + E * E) * 2 : (m * A + E) * 2;
        o[D] = v[Y], o[D + 1] = v[Y + 1], o[D + 2] = 0, o[D + 3] = 255;
      }
  }
}
var hn = class {
   ...
   */
  static generate() {
    const e = 10 * xe, t = ct.length * 5 * xe, i = new Uint8ClampedArray(e * t * 4), r = new oe(e, t, i), a = Math.pow(xe - 1, 2) + 1, s = ut, n = [], o = [];
...
var pn = class {
  ...
  generate() {
    ...
    return (t[0] !== null && t[1] !== null ? Promise.resolve(t) : vn(e)).then((r) => new Promise((a, s) => {
      const n = new Image(), o = new Image(), l = new Oe();
      l.onLoad = () => a([n, o]), l.onError = s, n.addEventListener("error", (u) => l.itemError("smaa-search")), o.addEventListener("error", (u) => l.itemError("smaa-area")), n.addEventListener("load", () => l.itemEnd("smaa-search")), o.addEventListener("load", () => l.itemEnd("smaa-area")), l.itemStart("smaa-search"), l.itemStart("smaa-area"), n.src = r[0], o.src = r[1];
    }));
  }
}, Ke = /* @__PURE__ */ new Map([
...
function K(e, t, i, r) {
  const a = ft(e, t, 0.75), s = ft(i, r, 1 - 0.25);
  return ft(a, s, 1 - 0.125);
}
function gn(e, t) {
  let i = 0;
...
var An = class {
   ...
   */
  static generate() {
    const s = new Uint8ClampedArray(2178), n = new Uint8ClampedArray(64 * 16 * 4);
    for (let o = 0; o < 33; ++o)
      for (let l = 0; l < 66; ++l) {
        const u = 0.03125 * l, f = 0.03125 * o;
        if (Ke.has(u) && Ke.has(f)) {
          const h = Ke.get(u), d = Ke.get(f), v = o * 66 + l;
          s[v] = 127 * gn(h, d), s[v + 33] = 127 * mn(h, d);
        }
      }
    for (let o = 0, l = 33 - 16; l < 33; ++l)
      for (let u = 0; u < 64; ++u, o += 4)
        n[o] = s[l * 66 + u], n[o + 3] = 255;
    return new oe(64, 16, n);
  }
};
const Mn = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  ChromaticAberrationEffect: la,
  CircleOfConfusionMaterial: hi,
  ClearMaskPass: ii,
  ClearPass: pe,
  ColorAverageEffect: ra,
  ColorChannel: ce,
  ColorDepthEffect: sa,
  ColorEdgesMaterial: mt,
  ...
  DepthOfFieldEffect: pa,
  DepthPass: Pt,
  DepthPickingPass: qs,
  DepthSavePass: Dt,
  DepthTestStrategy: ye,
  Disposable: tr,
  DotScreenEffect: ma,
  DownsamplingMaterial: li,
  EdgeDetectionMaterial: mt,
  ...
  EffectPass: $s,
  EffectShaderData: ai,
  EffectShaderSection: M,
  FXAAEffect: Da,
  GammaCorrectionEffect: Ta,
  GaussKernel: si,
  ...
  NoiseTexture: et,
  NormalPass: rn,
  OutlineEdgesMaterial: gt,
  OutlineEffect: ja,
  OutlineMaterial: gt,
  OverrideMaterialManager: pt,
  Pass: O,
  PixelationEffect: qa,
  PredicationMode: mi,
  RawImageData: oe,
  RealisticBokehEffect: $a,
  RenderPass: He,
  Resizable: lr,
  Resizer: x,
  Resolution: x,
  SMAAAreaImageData: hn,
  SMAAEffect: ps,
  SMAAImageGenerator: pn,
  SMAAImageLoader: Ns,
  SMAAPreset: Te,
  SMAASearchImageData: An,
  ...
  Section: M,
  Selection: Et,
  SelectiveBloomEffect: ns,
  SepiaEffect: ls,
  ShaderPass: J,
  ShockWaveEffect: ss,
  TetrahedralUpscaler: sn,
  TextureEffect: Es,
  ...
  VignetteEffect: Fs,
  VignetteTechnique: Se,
  WebGLExtension: Ga,
  version: er
}, Symbol.toStringTag, { value: "Module" })), ze = new ei();
ze.setAttribute("position", new qe(new Float32Array([
  -1,
  -1,
  3,
  -1,
...
ze.setAttribute("uv", new qe(new Float32Array([
  0,
  0,
  2,
  0,
...
ze.boundingSphere = new qi();
ze.computeBoundingSphere = function() {
};
const xn = new _i();
class q {
  constructor(t) {
    this._mesh = new Xt(ze, t), this._mesh.frustumCulled = !1;
  }
  render(t) {
    t.render(this._mesh, xn);
  }
  get material() {
...
const Dn = /* @__PURE__ */ (() => parseInt(Be.replace(/\D+/g, "")))(), Ni = Dn >= 162 ? class extends T {
  ...
  constructor(e = 1, t = 1, i = 1, r = {}) {
    ...
    this.texture = [];
    for (let s = 0; s < i; s++)
      this.texture[s] = a.clone(), this.texture[s].isRenderTargetTexture = !0;
  }
  setSize(e, t, i = 1) {
...
}, wn = Uint8Array.from(atob(Oi), (e) => e.charCodeAt(0));
function Hi(e, t, i) {
  if (t.getQueryParameter(e, t.QUERY_RESULT_AVAILABLE)) {
    const s = t.getQueryParameter(e, t.QUERY_RESULT) / 1e6;
...
class Tn extends O {
  ...
  constructor(t, i, r = 512, a = 512) {
    super(), this.width = r, this.height = a, this.clear = !0, this.camera = i, this.scene = t, this.autosetGamma = !0, this.configuration = new Proxy({
      ...
      set: (s, n, o) => {
        const l = s[n];
        return s[n] = o, o.equals ? o.equals(l) || this.firstFrame() : l !== o && this.firstFrame(), n === "aoSamples" && l !== o && this.configureAOPass(this.configuration.logarithmicDepthBuffer, this.camera.isOrthographicCamera), n === "denoiseSamples" && l !== o && this.configureDenoisePass(this.configuration.logarithmicDepthBuffer, this.camera.isOrthographicCamera), n === "halfRes" && l !== o && (this.configureAOPass(this.configuration.logarithmicDepthBuffer, this.camera.isOrthographicCamera), this.configureHalfResTargets(), this.configureEffectCompositer(this.configuration.logarithmicDepthBuffer, this.camera.isOrthographicCamera), this.setSize(this.width, this.height)), n === "depthAwareUpsampling" && l !== o && this.configureEffectCompositer(this.configuration.logarithmicDepthBuffer, this.camera.isOrthographicCamera), n === "gammaCorrection" && (this.autosetGamma = !1), n === "transparencyAware" && l !== o && (this.autoDetectTransparency = !1, this.configureTransparencyTarget()), !0;
      }
      ...
      depthBuffer: !1,
      alpha: !0
    }), this.accumulationQuad = new q(new w({
      uniforms: {
        frame: {
          value: 0
        },
      ...
      fragmentShader: `
             ...
             uniform float frame;
                ...
                `
    })), this.bluenoise = new it(wn, 128, 128), this.bluenoise.colorSpace = tt, this.bluenoise.wrapS = de, this.bluenoise.wrapT = de, this.bluenoise.minFilter = B, this.bluenoise.magFilter = B, this.bluenoise.needsUpdate = !0, this.lastTime = 0, this.timeRollingAverage = 0.99, this.needsDepthTexture = !0, this.needsSwap = !0, this._r = new p(), this._c = new H();
  }
  configureHalfResTargets() {
    this.firstFrame(), this.configuration.halfRes ? (this.depthDownsampleTarget = new Ni(this.width / 2, this.height / 2, 2), this.depthDownsampleTarget.textures[0].format = St, this.depthDownsampleTarget.textures[0].type = j, this.depthDownsampleTarget.textures[0].minFilter = B, this.depthDownsampleTarget.textures[0].magFilter = B, this.depthDownsampleTarget.textures[0].depthBuffer = !1, this.depthDownsampleTarget.textures[1].format = N, this.depthDownsampleTarget.textures[1].type = _, this.depthDownsampleTarget.textures[1].minFilter = B, this.depthDownsampleTarget.textures[1].magFilter = B, this.depthDownsampleTarget.textures[1].depthBuffer = !1, this.depthDownsampleQuad = new q(new w(Li))) : (this.depthDownsampleTarget && (this.depthDownsampleTarget.dispose(), this.depthDownsampleTarget = null), this.depthDownsampleQuad && (this.depthDownsampleQuad.dispose(), this.depthDownsampleQuad = null));
  }
  detectTransparency() {
  ...
  renderTransparency(t) {
    const i = this.scene.background, r = t.getClearColor(new H()), a = t.getClearAlpha(), s = /* @__PURE__ */ new Map(), n = t.autoClearDepth;
    this.scene.traverse((o) => {
      s.set(o, o.visible);
    }), this.scene.background = null, t.autoClearDepth = !1, t.setClearColor(new H(0, 0, 0), 0), this.depthCopyPass.material.uniforms.depthTexture.value = this.depthTexture, t.setRenderTarget(this.transparencyRenderTargetDWFalse), this.scene.traverse((o) => {
      o.material && (o.visible = s.get(o) && (o.material.transparent && !o.material.depthWrite && !o.userData.treatAsOpaque || !!o.userData.cannotReceiveAO));
      ...
      o.material && (o.visible = s.get(o) && o.material.transparent && o.material.depthWrite && !o.userData.treatAsOpaque);
    }), t.clear(!0, !0, !0), this.depthCopyPass.render(t), t.render(this.scene, this.camera), this.scene.traverse((o) => {
      o.visible = s.get(o);
    }), t.setClearColor(r, a), this.scene.background = i, t.autoClearDepth = n;
  }
...
` + r.fragmentShader), this.effectShaderQuad ? (this.effectShaderQuad.material.dispose(), this.effectShaderQuad.material = new w(r)) : this.effectShaderQuad = new q(new w(r));
  }
  configureDenoisePass(t = !1, i = !1) {
    this.firstFrame(), this.samplesDenoise = this.generateDenoiseSamples(this.configuration.denoiseSamples, 11);
    const r = {
      ...Fi
    };
    r.fragmentShader = r.fragmentShader.replace("16", this.configuration.denoiseSamples), t && (r.fragmentShader = `#define LOGDEPTH
` + r.fragmentShader), i && (r.fragmentShader = `#define ORTHO
` + r.fragmentShader), this.poissonBlurQuad ? (this.poissonBlurQuad.material.dispose(), this.poissonBlurQuad.material = new w(r)) : this.poissonBlurQuad = new q(new w(r));
  }
...
` + r.fragmentShader), this.effectCompositerQuad ? (this.effectCompositerQuad.material.dispose(), this.effectCompositerQuad.material = new w(r)) : this.effectCompositerQuad = new q(new w(r));
  }
  /**
       * 
       * @param {Number} n 
  ...
  generateHemisphereSamples(t) {
    const i = [];
    for (let r = 0; r < t; r++) {
      const a = 2.399963 * r, s = Math.sqrt(r + 0.5) / Math.sqrt(t), n = s * Math.cos(a), o = s * Math.sin(a), l = Math.sqrt(1 - (n * n + o * o));
      i.push(new F(n, o, l));
    }
    return i;
  }
  ...
  generateDenoiseSamples(t, i) {
    const r = 2 * Math.PI * i / t, a = 1 / t, s = a, n = [];
    let o = a, l = 0;
    for (let u = 0; u < t; u++)
      n.push(new p(Math.cos(l), Math.sin(l)).multiplyScalar(Math.pow(o, 0.75))), o += s, l += r;
    return n;
  }
  setSize(t, i) {
  ...
  render(t, i, r) {
    ...
    t.xr.enabled = !1, t.capabilities.logarithmicDepthBuffer !== this.configuration.logarithmicDepthBuffer && (this.configuration.logarithmicDepthBuffer = t.capabilities.logarithmicDepthBuffer, this.configureAOPass(this.configuration.logarithmicDepthBuffer, this.camera.isOrthographicCamera), this.configureDenoisePass(this.configuration.logarithmicDepthBuffer, this.camera.isOrthographicCamera), this.configureEffectCompositer(this.configuration.logarithmicDepthBuffer, this.camera.isOrthographicCamera)), this.detectTransparency(), (i.texture.type !== this.outputTargetInternal.texture.type || i.texture.format !== this.outputTargetInternal.texture.format) && (this.outputTargetInternal.texture.type = i.texture.type, this.outputTargetInternal.texture.format = i.texture.format, this.outputTargetInternal.texture.needsUpdate = !0), this.camera.updateMatrixWorld(), this.lastViewMatrix.equals(this.camera.matrixWorldInverse) && this.lastProjectionMatrix.equals(this.camera.projectionMatrix) && this.configuration.accumulate && !this.needsFrame ? this.frame++ : (this.configuration.accumulate && (t.setRenderTarget(this.accumulationRenderTarget), t.clear(!0, !0, !0)), this.frame = 0, this.needsFrame = !1), this.lastViewMatrix.copy(this.camera.matrixWorldInverse), this.lastProjectionMatrix.copy(this.camera.projectionMatrix);
    let s, n, o;
    this.debugMode && (s = t.getContext(), n = s.getExtension("EXT_disjoint_timer_query_webgl2"), n === null && (console.error("EXT_disjoint_timer_query_webgl2 not available, disabling debug mode."), this.debugMode = !1)), this.debugMode && (o = s.createQuery(), s.beginQuery(n.TIME_ELAPSED_EXT, o)), this.configuration.transparencyAware && this.renderTransparency(t), this._r.set(this.width, this.height);
    ...
    ), this.effectCompositerQuad.render(t), t.setRenderTarget(this.renderToScreen ? null : r), this.copyQuad.material.uniforms.tDiffuse.value = this.outputTargetInternal.texture, this.copyQuad.render(t), this.debugMode && (s.endQuery(n.TIME_ELAPSED_EXT), Hi(o, s, this)), t.xr.enabled = a;
  }
  /**
...
const Sn = Uint8Array.from(atob(Oi), (e) => e.charCodeAt(0));
function zi(e, t, i) {
  if (t.getQueryParameter(e, t.QUERY_RESULT_AVAILABLE)) {
    const s = t.getQueryParameter(e, t.QUERY_RESULT) / 1e6;
    i.lastTime = i.lastTime === 0 ? s : i.timeRollingAverage * i.lastTime + (1 - i.timeRollingAverage) * s;
...
class En extends $i {
  ...
  constructor(t, i, r = 512, a = 512) {
    super(), this.width = r, this.height = a, this.clear = !0, this.camera = i, this.scene = t, this.configuration = new Proxy({
      ...
      set: (s, n, o) => {
        const l = s[n];
        return s[n] = o, o.equals ? o.equals(l) || this.firstFrame() : l !== o && this.firstFrame(), n === "aoSamples" && l !== o && this.configureAOPass(this.configuration.logarithmicDepthBuffer, this.camera.isOrthographicCamera), n === "denoiseSamples" && l !== o && this.configureDenoisePass(this.configuration.logarithmicDepthBuffer, this.camera.isOrthographicCamera), n === "halfRes" && l !== o && (this.configureAOPass(this.configuration.logarithmicDepthBuffer, this.camera.isOrthographicCamera), this.configureHalfResTargets(), this.configureEffectCompositer(this.configuration.logarithmicDepthBuffer, this.camera.isOrthographicCamera), this.setSize(this.width, this.height)), n === "depthAwareUpsampling" && l !== o && this.configureEffectCompositer(this.configuration.logarithmicDepthBuffer, this.camera.isOrthographicCamera), n === "transparencyAware" && l !== o && (this.autoDetectTransparency = !1, this.configureTransparencyTarget()), n === "stencil" && l !== o && (this.beautyRenderTarget.dispose(), this.beautyRenderTarget = new T(this.width, this.height, {
          minFilter: P,
          magFilter: B,
          type: _,
          format: N,
      ...
      depthBuffer: !1,
      alpha: !0
    }), this.bluenoise = new it(Sn, 128, 128), this.accumulationQuad = new q(new w({
      uniforms: {
        frame: {
          value: 0
        },
      ...
      fragmentShader: `
             ...
             uniform float frame;
                ...
                `
    })), this.bluenoise.colorSpace = tt, this.bluenoise.wrapS = de, this.bluenoise.wrapT = de, this.bluenoise.minFilter = B, this.bluenoise.magFilter = B, this.bluenoise.needsUpdate = !0, this.lastTime = 0, this.timeRollingAverage = 0.99, this._r = new p(), this._c = new H();
  }
  configureHalfResTargets() {
    this.firstFrame(), this.configuration.halfRes ? (this.depthDownsampleTarget = new Ni(this.width / 2, this.height / 2, 2), this.depthDownsampleTarget.textures[0].format = St, this.depthDownsampleTarget.textures[0].type = j, this.depthDownsampleTarget.textures[0].minFilter = B, this.depthDownsampleTarget.textures[0].magFilter = B, this.depthDownsampleTarget.textures[0].depthBuffer = !1, this.depthDownsampleTarget.textures[1].format = N, this.depthDownsampleTarget.textures[1].type = _, this.depthDownsampleTarget.textures[1].minFilter = B, this.depthDownsampleTarget.textures[1].magFilter = B, this.depthDownsampleTarget.textures[1].depthBuffer = !1, this.depthDownsampleQuad = new q(new w(Li))) : (this.depthDownsampleTarget && (this.depthDownsampleTarget.dispose(), this.depthDownsampleTarget = null), this.depthDownsampleQuad && (this.depthDownsampleQuad.dispose(), this.depthDownsampleQuad = null));
  }
  ...
  renderTransparency(t) {
    ...
    this.scene.traverse((o) => {
      s.set(o, o.visible);
    }), this.scene.background = null, t.autoClearDepth = !1, t.setClearColor(new H(0, 0, 0), 0), this.depthCopyPass.material.uniforms.depthTexture.value = this.beautyRenderTarget.depthTexture, t.setRenderTarget(this.transparencyRenderTargetDWFalse), this.scene.traverse((o) => {
      o.material && (o.visible = s.get(o) && (o.material.transparent && !o.material.depthWrite && !o.userData.treatAsOpaque || !!o.userData.cannotReceiveAO));
    }), t.clear(!0, !0, !0), this.depthCopyPass.render(t), t.render(this.scene, this.camera), t.setRenderTarget(this.transparencyRenderTargetDWTrue), this.scene.traverse((o) => {
      o.material && (o.visible = s.get(o) && o.material.transparent && o.material.depthWrite && !o.userData.treatAsOpaque);
    }), t.clear(!0, !0, !0), this.depthCopyPass.render(t), t.render(this.scene, this.camera), this.scene.traverse((o) => {
...
` + r.fragmentShader), this.effectCompositerQuad ? (this.effectCompositerQuad.material.dispose(), this.effectCompositerQuad.material = new w(r)) : this.effectCompositerQuad = new q(new w(r));
  ...
  generateHemisphereSamples(t) {
    ...
    for (let r = 0; r < t; r++) {
      const a = 2.399963 * r;
      let s = Math.sqrt(r + 0.5) / Math.sqrt(t);
      const n = s * Math.cos(a), o = s * Math.sin(a), l = Math.sqrt(1 - (n * n + o * o));
      i.push(new F(n, o, l));
    }
    return i;
  }
  ...
  render(t, i, r, a, s) {
    ...
    let n, o, l;
    this.debugMode && (n = t.getContext(), o = n.getExtension("EXT_disjoint_timer_query_webgl2"), o === null && (console.error("EXT_disjoint_timer_query_webgl2 not available, disabling debug mode."), this.debugMode = !1)), this.configuration.autoRenderBeauty && (t.setRenderTarget(this.beautyRenderTarget), t.render(this.scene, this.camera), this.configuration.transparencyAware && this.renderTransparency(t)), this.debugMode && (l = n.createQuery(), n.beginQuery(o.TIME_ELAPSED_EXT, l));
