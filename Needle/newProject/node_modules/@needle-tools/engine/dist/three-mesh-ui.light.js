...
const u = ti({ BackSide: () => Rt, BufferAttribute: () => Bt, BufferGeometry: () => Ut, Color: () => At, DoubleSide: () => Tt, EventDispatcher: () => Mt, FileLoader: () => Ft, FrontSide: () => Ot, LinearFilter: () => Lt, Mesh: () => zt, MeshBasicMaterial: () => Wt, Object3D: () => Et, Plane: () => Dt, PlaneGeometry: () => Ht, ShaderMaterial: () => Gt, Texture: () => $t, TextureLoader: () => Nt, Vector2: () => Xt, Vector3: () => jt, Vector4: () => Yt });
class g extends p {
  /**
   *
   * @param {string} propertyId
  ...
  computeOutputValue(e) {
    ...
    if (t !== null) {
      ...
      if ((s._value === "hidden" || s._clippingPlanes !== null) && !this._clippingPlanes) {
        ...
        (s._value === "visible" || s._clippingPlanes === null) && this._clippingPlanes !== null && (this._clippingPlanes = null, this._renderStrategy = this._emptyRender, this._needsRender = !0);
    }
  }
  render(e) {
...
function Mr(i, e, t, s) {
  const r = i[e];
  if (r.lineBreak === "mandatory" || t + r.xadvance + r.xoffset + r.kerning > s.INNER_WIDTH)
    return !0;
  const n = pt(i, e, s);
...
class mt extends g {
  ...
  process(e) {
    if (!e._font._fontVariant || !e._font._fontVariant.isReady)
      return;
...
class $r extends p {
  ...
  render(e) {
    if (!e._inlines._value || !e._inlines._value.length)
      return;
